...
.method public constructor <init>(Landroid/content/Context;Lcom/amap/api/services/busline/BusLineQuery;)V
    ...
    iput-object v0, p0, Lcom/amap/api/col/fs;->f:Ljava/util/ArrayList;

    .line 33
    const/4 v0, 0x0

    iput-object v0, p0, Lcom/amap/api/col/fs;->g:Landroid/os/Handler;
    ...
    iput-object v0, p0, Lcom/amap/api/col/fs;->a:Landroid/content/Context;

    .line 43
    iput-object p2, p0, Lcom/amap/api/col/fs;->c:Lcom/amap/api/services/busline/BusLineQuery;
    ...
    iput-object v0, p0, Lcom/amap/api/col/fs;->d:Lcom/amap/api/services/busline/BusLineQuery;
...
.method static synthetic a(Lcom/amap/api/col/fs;)Lcom/amap/api/services/busline/BusLineSearch$OnBusLineSearchListener;
    .locals 1

    .prologue
    .line 24
    iget-object v0, p0, Lcom/amap/api/col/fs;->b:Lcom/amap/api/services/busline/BusLineSearch$OnBusLineSearchListener;
...
.method private a(Lcom/amap/api/services/busline/BusLineResult;)V
    ...
    :goto_0
    iget v1, p0, Lcom/amap/api/col/fs;->e:I

    if-ge v0, v1, :cond_0

    .line 94
    iget-object v1, p0, Lcom/amap/api/col/fs;->f:Ljava/util/ArrayList;
    ...
    .line 96
    :cond_0
    iget v0, p0, Lcom/amap/api/col/fs;->e:I

    if-ltz v0, :cond_1

    iget-object v0, p0, Lcom/amap/api/col/fs;->c:Lcom/amap/api/services/busline/BusLineQuery;

    invoke-virtual {v0}, Lcom/amap/api/services/busline/BusLineQuery;->getPageNumber()I

    move-result v0

    invoke-direct {p0, v0}, Lcom/amap/api/col/fs;->a(I)Z
    ...
    .line 97
    iget-object v0, p0, Lcom/amap/api/col/fs;->f:Ljava/util/ArrayList;

    iget-object v1, p0, Lcom/amap/api/col/fs;->c:Lcom/amap/api/services/busline/BusLineQuery;
...
.method static synthetic b(Lcom/amap/api/col/fs;)Landroid/os/Handler;
    .locals 1

    .prologue
    .line 24
    iget-object v0, p0, Lcom/amap/api/col/fs;->g:Landroid/os/Handler;
...
.method private b(I)Lcom/amap/api/services/busline/BusLineResult;
    ...
    .prologue
    .line 105
    invoke-direct {p0, p1}, Lcom/amap/api/col/fs;->a(I)Z
...
.method public searchBusLine()Lcom/amap/api/services/busline/BusLineResult;
    ...
    .line 61
    :try_start_0
    iget-object v0, p0, Lcom/amap/api/col/fs;->a:Landroid/content/Context;

    invoke-static {v0}, Lcom/amap/api/col/ex;->a(Landroid/content/Context;)Lcom/amap/api/col/ex;

    .line 62
    invoke-direct {p0}, Lcom/amap/api/col/fs;->a()Z
    ...
    iget-object v1, p0, Lcom/amap/api/col/fs;->d:Lcom/amap/api/services/busline/BusLineQuery;
    ...
    iput v0, p0, Lcom/amap/api/col/fs;->e:I
    ...
    iget-object v1, p0, Lcom/amap/api/col/fs;->a:Landroid/content/Context;

    iget-object v2, p0, Lcom/amap/api/col/fs;->c:Lcom/amap/api/services/busline/BusLineQuery;
    ...
    .line 75
    invoke-direct {p0, v0}, Lcom/amap/api/col/fs;->a(Lcom/amap/api/services/busline/BusLineResult;)V
    ...
    invoke-direct {p0, v0}, Lcom/amap/api/col/fs;->b(I)Lcom/amap/api/services/busline/BusLineResult;
...
.method public searchBusLineAsyn()V
    ...
    invoke-direct {v1, p0}, Lcom/amap/api/col/fs$1;-><init>(Lcom/amap/api/col/fs;)V
...
.method public setOnBusLineSearchListener(Lcom/amap/api/services/busline/BusLineSearch$OnBusLineSearchListener;)V
    ...
    .prologue
    .line 118
    iput-object p1, p0, Lcom/amap/api/col/fs;->b:Lcom/amap/api/services/busline/BusLineSearch$OnBusLineSearchListener;
...
.method public setQuery(Lcom/amap/api/services/busline/BusLineQuery;)V
    ...
    .line 155
    iput-object p1, p0, Lcom/amap/api/col/fs;->c:Lcom/amap/api/services/busline/BusLineQuery;
