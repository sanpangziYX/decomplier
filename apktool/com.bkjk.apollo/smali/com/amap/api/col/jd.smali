.class public Lcom/amap/api/col/jd;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/amap/api/col/jd$a;
    }
.end annotation


# static fields
.field private static a:Lcom/amap/api/col/jd;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/amap/api/col/jd;->a:Lcom/amap/api/col/jd;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/amap/api/col/jd;->b:Ljava/util/Hashtable;

    .line 30
    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lcom/amap/api/col/jd;->c:J

    .line 31
    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/amap/api/col/jd;->d:Z

    .line 35
    return-void
.end method

.method private declared-synchronized a(Ljava/lang/StringBuilder;Ljava/lang/String;)Lcom/amap/api/col/jd$a;
    .locals 18
    ...
    iget-object v2, v0, Lcom/amap/api/col/jd;->b:Ljava/util/Hashtable;
    ...
    check-cast v0, Lcom/amap/api/col/jd$a;

    move-object v4, v0

    .line 365
    invoke-virtual {v4}, Lcom/amap/api/col/jd$a;->b()Ljava/lang/String;
    ...
    invoke-direct {v0, v6, v1}, Lcom/amap/api/col/jd;->b(Ljava/lang/String;Ljava/lang/StringBuilder;)Z
    ...
    invoke-virtual {v0, v6, v1}, Lcom/amap/api/col/jd;->a(Ljava/lang/String;Ljava/lang/StringBuilder;)Z
    ...
    invoke-direct {v0, v3, v11}, Lcom/amap/api/col/jd;->a(Ljava/lang/String;Ljava/util/Hashtable;)V
    ...
    invoke-direct {v0, v3, v12}, Lcom/amap/api/col/jd;->a(Ljava/lang/String;Ljava/util/Hashtable;)V
    ...
    invoke-direct {v0, v15, v1}, Lcom/amap/api/col/jd;->a([D[D)[D
...
.method public static declared-synchronized a()Lcom/amap/api/col/jd;
    .locals 2

    .prologue
    .line 44
    const-class v1, Lcom/amap/api/col/jd;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lcom/amap/api/col/jd;->a:Lcom/amap/api/col/jd;

    if-nez v0, :cond_0

    .line 45
    new-instance v0, Lcom/amap/api/col/jd;

    invoke-direct {v0}, Lcom/amap/api/col/jd;-><init>()V
...
.method public declared-synchronized a(Ljava/lang/String;Ljava/lang/StringBuilder;Z)Lcom/autonavi/aps/amapapi/model/AMapLocationServer;
    ...
    .line 225
    invoke-static {}, Lcom/amap/api/col/jn;->r()Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_2
    :try_start_1
    invoke-virtual {p0}, Lcom/amap/api/col/jd;->b()Z
    ...
    .line 232
    invoke-virtual {p0}, Lcom/amap/api/col/jd;->c()V
    ...
    .line 235
    :cond_3
    iget-object v0, p0, Lcom/amap/api/col/jd;->b:Ljava/util/Hashtable;
    ...
    .line 247
    invoke-direct {p0, p2, p1}, Lcom/amap/api/col/jd;->a(Ljava/lang/StringBuilder;Ljava/lang/String;)Lcom/amap/api/col/jd$a;
    ...
    invoke-virtual {v0}, Lcom/amap/api/col/jd$a;->a()Lcom/autonavi/aps/amapapi/model/AMapLocationServer;
    ...
    .line 273
    sget-object v2, Lcom/amap/api/col/c;->d:Ljava/lang/String;
    ...
    sput-object v2, Lcom/amap/api/col/c;->d:Ljava/lang/String;
    ...
    invoke-static {v2, v3}, Lcom/amap/api/col/jn;->b(J)Z
...
.method public a(Landroid/content/Context;)V
    ...
    .prologue
    .line 733
    iget-boolean v0, p0, Lcom/amap/api/col/jd;->d:Z
    ...
    invoke-virtual {v0, p1}, Lcom/amap/api/col/jf;->a(Landroid/content/Context;)V
    :try_end_0
...
.method public declared-synchronized a(Ljava/lang/String;Ljava/lang/StringBuilder;Lcom/autonavi/aps/amapapi/model/AMapLocationServer;Landroid/content/Context;Z)V
    ...
    :try_start_0
    invoke-virtual {p0, p1, p3}, Lcom/amap/api/col/jd;->a(Ljava/lang/String;Lcom/autonavi/aps/amapapi/model/AMapLocationServer;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-static {v1, v2}, Lcom/amap/api/col/ju;->a(Lorg/json/JSONObject;Ljava/lang/String;)Z
    ...
    .line 140
    invoke-static {v3}, Lcom/amap/api/col/ju;->a(Lcom/autonavi/aps/amapapi/model/AMapLocationServer;)Z
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/amap/api/col/jd;->a(Ljava/lang/String;Ljava/lang/StringBuilder;Z)Lcom/autonavi/aps/amapapi/model/AMapLocationServer;
    ...
    .line 181
    new-instance v1, Lcom/amap/api/col/jd$a;

    invoke-direct {v1}, Lcom/amap/api/col/jd$a;-><init>()V

    .line 182
    invoke-virtual {v1, p3}, Lcom/amap/api/col/jd$a;->a(Lcom/autonavi/aps/amapapi/model/AMapLocationServer;)V
    ...
    :goto_2
    invoke-virtual {v1, v0}, Lcom/amap/api/col/jd$a;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1, p3, p2, p4}, Lcom/amap/api/col/jf;->a(Ljava/lang/String;Lcom/amap/api/location/AMapLocation;Ljava/lang/StringBuilder;Landroid/content/Context;)V
    :try_end_2
    ...
    .line 189
    iget-object v1, p0, Lcom/amap/api/col/jd;->b:Ljava/util/Hashtable;
...
.method public a(Ljava/lang/String;Lcom/autonavi/aps/amapapi/model/AMapLocationServer;)Z
    ...
    invoke-static {p2}, Lcom/amap/api/col/ju;->a(Lcom/autonavi/aps/amapapi/model/AMapLocationServer;)Z
...
.method public b()Z
    ...
    iget-wide v4, p0, Lcom/amap/api/col/jd;->c:J
    ...
    .line 294
    :cond_1
    iget-object v4, p0, Lcom/amap/api/col/jd;->b:Ljava/util/Hashtable;
