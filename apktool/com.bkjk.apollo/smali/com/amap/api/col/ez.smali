.class public Lcom/amap/api/col/ez;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/amap/api/col/ez$j;,
        Lcom/amap/api/col/ez$k;,
        Lcom/amap/api/col/ez$l;,
        Lcom/amap/api/col/ez$c;,
        Lcom/amap/api/col/ez$d;,
        Lcom/amap/api/col/ez$f;,
        Lcom/amap/api/col/ez$i;,
        Lcom/amap/api/col/ez$e;,
        Lcom/amap/api/col/ez$h;,
        Lcom/amap/api/col/ez$g;,
        Lcom/amap/api/col/ez$b;,
        Lcom/amap/api/col/ez$a;
    }
.end annotation


# static fields
.field private static a:Lcom/amap/api/col/ez;
...
.method public static declared-synchronized a()Lcom/amap/api/col/ez;
    .locals 3

    .prologue
    .line 184
    const-class v1, Lcom/amap/api/col/ez;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lcom/amap/api/col/ez;->a:Lcom/amap/api/col/ez;
    ...
    invoke-direct {v0, v2}, Lcom/amap/api/col/ez;-><init>(Landroid/os/Looper;)V

    sput-object v0, Lcom/amap/api/col/ez;->a:Lcom/amap/api/col/ez;
    ...
    invoke-direct {v0}, Lcom/amap/api/col/ez;-><init>()V
...
.method private c(Landroid/os/Message;)V
    ...
    check-cast v0, Lcom/amap/api/col/ez$f;
    ...
    .line 302
    :cond_1
    iget-object v2, v0, Lcom/amap/api/col/ez$f;->a:Ljava/util/List;
    ...
    .line 308
    iget-object v0, v0, Lcom/amap/api/col/ez$f;->b:Lcom/amap/api/services/nearby/NearbySearchResult;
...
.method private e(Landroid/os/Message;)V
    ...
    check-cast v0, Lcom/amap/api/col/ez$b;
    ...
    .line 331
    :cond_1
    iget-object v2, v0, Lcom/amap/api/col/ez$b;->b:Lcom/amap/api/services/busline/BusStationSearch$OnBusStationSearchListener;
    ...
    .line 336
    iget-object v0, v0, Lcom/amap/api/col/ez$b;->a:Lcom/amap/api/services/busline/BusStationResult;
...
.method private f(Landroid/os/Message;)V
    ...
    check-cast v0, Lcom/amap/api/col/ez$h;
    ...
    .line 349
    :cond_1
    iget-object v1, v0, Lcom/amap/api/col/ez$h;->b:Lcom/amap/api/services/poisearch/PoiSearch$OnPoiSearchListener;
    ...
    .line 357
    iget-object v0, v0, Lcom/amap/api/col/ez$h;->a:Lcom/amap/api/services/poisearch/PoiResult;
    ...
    check-cast v0, Lcom/amap/api/col/ez$g;

    .line 361
    if-eqz v0, :cond_0

    .line 364
    iget-object v1, v0, Lcom/amap/api/col/ez$g;->b:Lcom/amap/api/services/poisearch/PoiSearch$OnPoiSearchListener;
    ...
    .line 368
    iget-object v0, v0, Lcom/amap/api/col/ez$g;->a:Lcom/amap/api/services/core/PoiItem;
...
.method private h(Landroid/os/Message;)V
    ...
    check-cast v0, Lcom/amap/api/col/ez$i;
    ...
    .line 404
    :cond_1
    iget-object v1, v0, Lcom/amap/api/col/ez$i;->b:Lcom/amap/api/services/geocoder/GeocodeSearch$OnGeocodeSearchListener;

    .line 405
    if-eqz v1, :cond_0

    .line 410
    iget-object v0, v0, Lcom/amap/api/col/ez$i;->a:Lcom/amap/api/services/geocoder/RegeocodeResult;
    ...
    check-cast v0, Lcom/amap/api/col/ez$e;

    .line 415
    if-eqz v0, :cond_0

    .line 418
    iget-object v1, v0, Lcom/amap/api/col/ez$e;->b:Lcom/amap/api/services/geocoder/GeocodeSearch$OnGeocodeSearchListener;

    .line 419
    if-eqz v1, :cond_0

    .line 424
    iget-object v0, v0, Lcom/amap/api/col/ez$e;->a:Lcom/amap/api/services/geocoder/GeocodeResult;
...
.method private j(Landroid/os/Message;)V
    ...
    check-cast v0, Lcom/amap/api/col/ez$a;
    ...
    .line 443
    :cond_1
    iget-object v2, v0, Lcom/amap/api/col/ez$a;->b:Lcom/amap/api/services/busline/BusLineSearch$OnBusLineSearchListener;
    ...
    .line 449
    iget-object v0, v0, Lcom/amap/api/col/ez$a;->a:Lcom/amap/api/services/busline/BusLineResult;
...
.method private l(Landroid/os/Message;)V
    ...
    check-cast v0, Lcom/amap/api/col/ez$d;
    ...
    .line 500
    :cond_1
    iget-object v1, v0, Lcom/amap/api/col/ez$d;->b:Lcom/amap/api/services/cloud/CloudSearch$OnCloudSearchListener;

    .line 501
    iget-object v0, v0, Lcom/amap/api/col/ez$d;->a:Lcom/amap/api/services/cloud/CloudResult;
    ...
    check-cast v0, Lcom/amap/api/col/ez$c;

    .line 505
    if-eqz v0, :cond_0

    .line 508
    iget-object v1, v0, Lcom/amap/api/col/ez$c;->b:Lcom/amap/api/services/cloud/CloudSearch$OnCloudSearchListener;

    .line 509
    iget-object v0, v0, Lcom/amap/api/col/ez$c;->a:Lcom/amap/api/services/cloud/CloudItemDetail;
...
.method private m(Landroid/os/Message;)V
    ...
    check-cast v0, Lcom/amap/api/col/ez$l;
    ...
    .line 520
    :cond_1
    iget-object v1, v0, Lcom/amap/api/col/ez$l;->b:Lcom/amap/api/services/weather/WeatherSearch$OnWeatherSearchListener;
    ...
    .line 527
    iget-object v0, v0, Lcom/amap/api/col/ez$l;->a:Lcom/amap/api/services/weather/LocalWeatherLiveResult;
    ...
    check-cast v0, Lcom/amap/api/col/ez$k;

    .line 531
    if-eqz v0, :cond_0

    .line 534
    iget-object v1, v0, Lcom/amap/api/col/ez$k;->b:Lcom/amap/api/services/weather/WeatherSearch$OnWeatherSearchListener;
    ...
    .line 541
    iget-object v0, v0, Lcom/amap/api/col/ez$k;->a:Lcom/amap/api/services/weather/LocalWeatherForecastResult;
...
.method private n(Landroid/os/Message;)V
    ...
    check-cast v0, Lcom/amap/api/col/ez$j;
    ...
    .line 550
    :cond_1
    iget-object v1, v0, Lcom/amap/api/col/ez$j;->b:Lcom/amap/api/services/routepoisearch/RoutePOISearch$OnRoutePOISearchListener;
    ...
    .line 556
    iget-object v0, v0, Lcom/amap/api/col/ez$j;->a:Lcom/amap/api/services/routepoisearch/RoutePOISearchResult;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 208
    :pswitch_0
    invoke-direct {p0, p1}, Lcom/amap/api/col/ez;->k(Landroid/os/Message;)V
    :try_end_0
    ...
    :pswitch_1
    :try_start_1
    invoke-direct {p0, p1}, Lcom/amap/api/col/ez;->j(Landroid/os/Message;)V

    goto :goto_0

    .line 214
    :pswitch_2
    invoke-direct {p0, p1}, Lcom/amap/api/col/ez;->i(Landroid/os/Message;)V

    goto :goto_0

    .line 217
    :pswitch_3
    invoke-direct {p0, p1}, Lcom/amap/api/col/ez;->h(Landroid/os/Message;)V

    goto :goto_0

    .line 220
    :pswitch_4
    invoke-direct {p0, p1}, Lcom/amap/api/col/ez;->g(Landroid/os/Message;)V

    goto :goto_0

    .line 223
    :pswitch_5
    invoke-direct {p0, p1}, Lcom/amap/api/col/ez;->f(Landroid/os/Message;)V

    goto :goto_0

    .line 226
    :pswitch_6
    invoke-direct {p0, p1}, Lcom/amap/api/col/ez;->e(Landroid/os/Message;)V

    goto :goto_0

    .line 229
    :pswitch_7
    invoke-direct {p0, p1}, Lcom/amap/api/col/ez;->d(Landroid/os/Message;)V

    goto :goto_0

    .line 232
    :pswitch_8
    invoke-direct {p0, p1}, Lcom/amap/api/col/ez;->c(Landroid/os/Message;)V

    goto :goto_0

    .line 235
    :pswitch_9
    invoke-direct {p0, p1}, Lcom/amap/api/col/ez;->b(Landroid/os/Message;)V

    goto :goto_0

    .line 238
    :pswitch_a
    invoke-direct {p0, p1}, Lcom/amap/api/col/ez;->a(Landroid/os/Message;)V

    goto :goto_0

    .line 241
    :pswitch_b
    invoke-direct {p0, p1}, Lcom/amap/api/col/ez;->l(Landroid/os/Message;)V

    goto :goto_0

    .line 244
    :pswitch_c
    invoke-direct {p0, p1}, Lcom/amap/api/col/ez;->m(Landroid/os/Message;)V

    goto :goto_0

    .line 247
    :pswitch_d
    invoke-direct {p0, p1}, Lcom/amap/api/col/ez;->n(Landroid/os/Message;)V
    :try_end_1
