.class public Lcom/amap/api/col/ft;
...
.method public constructor <init>(Landroid/content/Context;Lcom/amap/api/services/busline/BusStationQuery;)V
    ...
    iput-object v0, p0, Lcom/amap/api/col/ft;->e:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/amap/api/col/ft;->a:Landroid/content/Context;

    .line 42
    iput-object p2, p0, Lcom/amap/api/col/ft;->c:Lcom/amap/api/services/busline/BusStationQuery;
    ...
    iput-object v0, p0, Lcom/amap/api/col/ft;->g:Landroid/os/Handler;

    .line 44
    return-void
.end method

.method static synthetic a(Lcom/amap/api/col/ft;)Lcom/amap/api/services/busline/BusStationSearch$OnBusStationSearchListener;
    .locals 1

    .prologue
    .line 24
    iget-object v0, p0, Lcom/amap/api/col/ft;->b:Lcom/amap/api/services/busline/BusStationSearch$OnBusStationSearchListener;
...
.method private a(Lcom/amap/api/services/busline/BusStationResult;)V
    ...
    :goto_0
    iget v1, p0, Lcom/amap/api/col/ft;->f:I

    if-gt v0, v1, :cond_0

    .line 92
    iget-object v1, p0, Lcom/amap/api/col/ft;->e:Ljava/util/ArrayList;
    ...
    .line 94
    :cond_0
    iget v0, p0, Lcom/amap/api/col/ft;->f:I

    if-lez v0, :cond_1

    .line 95
    iget-object v0, p0, Lcom/amap/api/col/ft;->e:Ljava/util/ArrayList;

    iget-object v1, p0, Lcom/amap/api/col/ft;->c:Lcom/amap/api/services/busline/BusStationQuery;
...
.method static synthetic b(Lcom/amap/api/col/ft;)Landroid/os/Handler;
    .locals 1

    .prologue
    .line 24
    iget-object v0, p0, Lcom/amap/api/col/ft;->g:Landroid/os/Handler;
...
.method private b(I)Lcom/amap/api/services/busline/BusStationResult;
    ...
    .prologue
    .line 103
    invoke-direct {p0, p1}, Lcom/amap/api/col/ft;->a(I)Z
...
.method public getQuery()Lcom/amap/api/services/busline/BusStationQuery;
    ...
    .prologue
    .line 163
    iget-object v0, p0, Lcom/amap/api/col/ft;->c:Lcom/amap/api/services/busline/BusStationQuery;
...
.method public searchBusStation()Lcom/amap/api/services/busline/BusStationResult;
    ...
    .line 58
    :try_start_0
    iget-object v0, p0, Lcom/amap/api/col/ft;->a:Landroid/content/Context;
    ...
    iget-object v1, p0, Lcom/amap/api/col/ft;->d:Lcom/amap/api/services/busline/BusStationQuery;
    ...
    iput-object v0, p0, Lcom/amap/api/col/ft;->d:Lcom/amap/api/services/busline/BusStationQuery;
    ...
    .line 70
    new-instance v0, Lcom/amap/api/col/em;

    iget-object v1, p0, Lcom/amap/api/col/ft;->a:Landroid/content/Context;

    iget-object v2, p0, Lcom/amap/api/col/ft;->c:Lcom/amap/api/services/busline/BusStationQuery;

    invoke-direct {v0, v1, v2}, Lcom/amap/api/col/em;-><init>(Landroid/content/Context;Ljava/lang/Object;)V

    .line 71
    invoke-virtual {v0}, Lcom/amap/api/col/em;->c()Ljava/lang/Object;
    ...
    iput v1, p0, Lcom/amap/api/col/ft;->f:I

    .line 73
    invoke-direct {p0, v0}, Lcom/amap/api/col/ft;->a(Lcom/amap/api/services/busline/BusStationResult;)V
    ...
    invoke-direct {p0, v0}, Lcom/amap/api/col/ft;->b(I)Lcom/amap/api/services/busline/BusStationResult;
...
.method public searchBusStationAsyn()V
    ...
    new-instance v1, Lcom/amap/api/col/ft$1;

    invoke-direct {v1, p0}, Lcom/amap/api/col/ft$1;-><init>(Lcom/amap/api/col/ft;)V
...
.method public setOnBusStationSearchListener(Lcom/amap/api/services/busline/BusStationSearch$OnBusStationSearchListener;)V
    ...
    .prologue
    .line 116
    iput-object p1, p0, Lcom/amap/api/col/ft;->b:Lcom/amap/api/services/busline/BusStationSearch$OnBusStationSearchListener;
...
.method public setQuery(Lcom/amap/api/services/busline/BusStationQuery;)V
    ...
    .line 153
    iput-object p1, p0, Lcom/amap/api/col/ft;->c:Lcom/amap/api/services/busline/BusStationQuery;
