...
.method private decryptBlock([BII[B)[B
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/engines/IESEngine;->macBuf:[B
...
.method private encryptBlock([BII[B)[B
    ...
    invoke-direct {v0, v2, p3, v3}, Lorg/bouncycastle/crypto/params/KeyParameter;-><init>([BII)V
    ...
    invoke-interface {v0, v1, v5, p3}, Lorg/bouncycastle/crypto/Mac;->update([BII)V

    iget-object v0, p0, Lorg/bouncycastle/crypto/engines/IESEngine;->mac:Lorg/bouncycastle/crypto/Mac;

    array-length v3, v2

    invoke-interface {v0, v2, v5, v3}, Lorg/bouncycastle/crypto/Mac;->update([BII)V

    iget-object v0, p0, Lorg/bouncycastle/crypto/engines/IESEngine;->mac:Lorg/bouncycastle/crypto/Mac;

    invoke-interface {v0, v1, p3}, Lorg/bouncycastle/crypto/Mac;->doFinal([BI)I
    ...
    invoke-direct {v0, v8, v2, v3}, Lorg/bouncycastle/crypto/params/KeyParameter;-><init>([BII)V
