...
.method addBytesToWriteWindow(J)V
    ...
    .line 453
    .local v0, "socket":Lcom/koushikdutta/async/http/spdy/AsyncSpdyConnection$SpdySocket;
    invoke-static {v0}, Lcom/koushikdutta/async/Util;->writable(Lcom/koushikdutta/async/DataSink;)V
...
.method public settings(ZLcom/koushikdutta/async/http/spdy/Settings;)V
    ...
    .line 428
    .local v0, "delta":J
    iget-object v6, p0, Lcom/koushikdutta/async/http/spdy/AsyncSpdyConnection;->peerSettings:Lcom/koushikdutta/async/http/spdy/Settings;

    invoke-virtual {v6, v7}, Lcom/koushikdutta/async/http/spdy/Settings;->getInitialWindowSize(I)I
    ...
    invoke-virtual {v6, p2}, Lcom/koushikdutta/async/http/spdy/Settings;->merge(Lcom/koushikdutta/async/http/spdy/Settings;)V

    .line 433
    :try_start_0
    iget-object v6, p0, Lcom/koushikdutta/async/http/spdy/AsyncSpdyConnection;->writer:Lcom/koushikdutta/async/http/spdy/FrameWriter;

    invoke-interface {v6}, Lcom/koushikdutta/async/http/spdy/FrameWriter;->ackSettings()V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 440
    iget-boolean v6, p0, Lcom/koushikdutta/async/http/spdy/AsyncSpdyConnection;->receivedInitialPeerSettings:Z
    ...
    iput-boolean v6, p0, Lcom/koushikdutta/async/http/spdy/AsyncSpdyConnection;->receivedInitialPeerSettings:Z

    .line 445
    :cond_1
    iget-object v6, p0, Lcom/koushikdutta/async/http/spdy/AsyncSpdyConnection;->sockets:Ljava/util/Hashtable;
