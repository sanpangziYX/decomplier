...
# virtual methods
.method checkTerminated(ZZLio/reactivex/ac;Z)Z
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
...
.method drain()V
    ...
    .line 296
    :goto_2
    invoke-virtual {p0, v6, v0, v2, v5}, Lio/reactivex/internal/operators/observable/ObservableGroupBy$State;->checkTerminated(ZZLio/reactivex/ac;Z)Z
    ...
    .line 304
    :cond_5
    invoke-interface {v2, v7}, Lio/reactivex/ac;->onNext(Ljava/lang/Object;)V
...
.method public subscribe(Lio/reactivex/ac;)V
    ...
    .line 252
    invoke-interface {p1, p0}, Lio/reactivex/ac;->onSubscribe(Lio/reactivex/disposables/b;)V
