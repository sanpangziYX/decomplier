...
.field final worker:Lio/reactivex/ad$c;
...
.method constructor <init>(Lio/reactivex/ac;Lio/reactivex/ad$c;ZI)V
    ...
    .line 72
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableObserveOn$ObserveOnObserver;->actual:Lio/reactivex/ac;

    .line 73
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableObserveOn$ObserveOnObserver;->worker:Lio/reactivex/ad$c;
...
# virtual methods
.method checkTerminated(ZZLio/reactivex/ac;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
    ...
    .line 258
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableObserveOn$ObserveOnObserver;->queue:Lio/reactivex/internal/a/o;
    ...
    .line 266
    invoke-interface {p3, v1}, Lio/reactivex/ac;->onError(Ljava/lang/Throwable;)V

    .line 270
    :goto_1
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableObserveOn$ObserveOnObserver;->worker:Lio/reactivex/ad$c;
    ...
    .line 275
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/ObservableObserveOn$ObserveOnObserver;->queue:Lio/reactivex/internal/a/o;
...
.method public dispose()V
    ...
    .line 147
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableObserveOn$ObserveOnObserver;->worker:Lio/reactivex/ad$c;
...
.method drainFused()V
    ...
    .line 222
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableObserveOn$ObserveOnObserver;->actual:Lio/reactivex/ac;
    ...
    .line 227
    :cond_2
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/ObservableObserveOn$ObserveOnObserver;->actual:Lio/reactivex/ac;

    const/4 v3, 0x0

    invoke-interface {v2, v3}, Lio/reactivex/ac;->onNext(Ljava/lang/Object;)V
    ...
    .line 232
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableObserveOn$ObserveOnObserver;->actual:Lio/reactivex/ac;
...
.method drainNormal()V
    ...
    .line 166
    .line 168
    iget-object v3, p0, Lio/reactivex/internal/operators/observable/ObservableObserveOn$ObserveOnObserver;->queue:Lio/reactivex/internal/a/o;

    .line 169
    iget-object v4, p0, Lio/reactivex/internal/operators/observable/ObservableObserveOn$ObserveOnObserver;->actual:Lio/reactivex/ac;
    ...
    invoke-virtual {p0, v2, v5, v4}, Lio/reactivex/internal/operators/observable/ObservableObserveOn$ObserveOnObserver;->checkTerminated(ZZLio/reactivex/ac;)Z
    ...
    .line 200
    :cond_2
    invoke-interface {v4, v6}, Lio/reactivex/ac;->onNext(Ljava/lang/Object;)V
    ...
    .line 192
    :goto_1
    invoke-virtual {p0, v5, v2, v4}, Lio/reactivex/internal/operators/observable/ObservableObserveOn$ObserveOnObserver;->checkTerminated(ZZLio/reactivex/ac;)Z
    ...
    .line 186
    invoke-interface {v4, v0}, Lio/reactivex/ac;->onError(Ljava/lang/Throwable;)V
...
.method public onSubscribe(Lio/reactivex/disposables/b;)V
    ...
    iput-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableObserveOn$ObserveOnObserver;->queue:Lio/reactivex/internal/a/o;
