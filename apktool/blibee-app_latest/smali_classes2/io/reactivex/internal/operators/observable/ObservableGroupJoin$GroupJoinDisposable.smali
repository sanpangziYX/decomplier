...
.method constructor <init>(Lio/reactivex/ac;Lio/reactivex/c/h;Lio/reactivex/c/h;Lio/reactivex/c/c;)V
    ...
    .line 133
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->actual:Lio/reactivex/ac;
...
.method drain()V
    ...
    .line 194
    iget-object v7, p0, Lio/reactivex/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->actual:Lio/reactivex/ac;
    ...
    .line 207
    invoke-virtual {p0, v7}, Lio/reactivex/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->errorAll(Lio/reactivex/ac;)V
    ...
    .line 256
    invoke-interface {v0, v9}, Lio/reactivex/aa;->subscribe(Lio/reactivex/ac;)V
    ...
    .line 249
    invoke-virtual {p0, v0, v7, v6}, Lio/reactivex/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->fail(Ljava/lang/Throwable;Lio/reactivex/ac;Lio/reactivex/internal/queue/a;)V
    ...
    .line 275
    invoke-interface {v7, v0}, Lio/reactivex/ac;->onNext(Ljava/lang/Object;)V
    ...
    .line 301
    invoke-interface {v0, v8}, Lio/reactivex/aa;->subscribe(Lio/reactivex/ac;)V
...
.method errorAll(Lio/reactivex/ac;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method fail(Ljava/lang/Throwable;Lio/reactivex/ac;Lio/reactivex/internal/queue/a;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 184
    invoke-virtual {p0, p2}, Lio/reactivex/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->errorAll(Lio/reactivex/ac;)V
