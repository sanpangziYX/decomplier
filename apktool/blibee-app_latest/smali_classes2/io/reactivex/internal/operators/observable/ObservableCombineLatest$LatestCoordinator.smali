...
.field final observers:[Lio/reactivex/internal/operators/observable/ObservableCombineLatest$a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "[",
...
.method constructor <init>(Lio/reactivex/ac;Lio/reactivex/c/h;IIZ)V
    ...
    .line 99
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableCombineLatest$LatestCoordinator;->actual:Lio/reactivex/ac;
    ...
    iput-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableCombineLatest$LatestCoordinator;->observers:[Lio/reactivex/internal/operators/observable/ObservableCombineLatest$a;
...
# virtual methods
.method cancel(Lio/reactivex/internal/queue/a;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .line 140
    invoke-virtual {p0, p1}, Lio/reactivex/internal/operators/observable/ObservableCombineLatest$LatestCoordinator;->clear(Lio/reactivex/internal/queue/a;)V
...
.method cancelSources()V
    ...
    .prologue
    .line 145
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableCombineLatest$LatestCoordinator;->observers:[Lio/reactivex/internal/operators/observable/ObservableCombineLatest$a;
...
.method checkTerminated(ZZLio/reactivex/ac;Lio/reactivex/internal/queue/a;Z)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
    ...
    .line 259
    invoke-virtual {p0, p4}, Lio/reactivex/internal/operators/observable/ObservableCombineLatest$LatestCoordinator;->cancel(Lio/reactivex/internal/queue/a;)V
    ...
    .line 268
    invoke-interface {p3, v0}, Lio/reactivex/ac;->onError(Ljava/lang/Throwable;)V
    ...
    .line 270
    :cond_1
    invoke-interface {p3}, Lio/reactivex/ac;->onComplete()V
...
.method clear(Lio/reactivex/internal/queue/a;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method combine(Ljava/lang/Object;I)V
    ...
    .line 158
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/ObservableCombineLatest$LatestCoordinator;->observers:[Lio/reactivex/internal/operators/observable/ObservableCombineLatest$a;
    ...
    invoke-virtual {v0, v5, v1}, Lio/reactivex/internal/queue/a;->offer(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method drain()V
    ...
    .line 207
    iget-object v3, p0, Lio/reactivex/internal/operators/observable/ObservableCombineLatest$LatestCoordinator;->actual:Lio/reactivex/ac;
    ...
    invoke-virtual/range {v0 .. v5}, Lio/reactivex/internal/operators/observable/ObservableCombineLatest$LatestCoordinator;->checkTerminated(ZZLio/reactivex/ac;Lio/reactivex/internal/queue/a;Z)Z
    ...
    .line 237
    :try_start_0
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableCombineLatest$LatestCoordinator;->combiner:Lio/reactivex/c/h;

    invoke-interface {v1, v0}, Lio/reactivex/c/h;->apply(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    const-string/jumbo v1, "The combiner returned a null"
    ...
    .line 246
    invoke-interface {v3, v0}, Lio/reactivex/ac;->onNext(Ljava/lang/Object;)V
    ...
    .line 241
    invoke-virtual {p0, v4}, Lio/reactivex/internal/operators/observable/ObservableCombineLatest$LatestCoordinator;->cancel(Lio/reactivex/internal/queue/a;)V

    .line 242
    invoke-interface {v3, v0}, Lio/reactivex/ac;->onError(Ljava/lang/Throwable;)V
...
.method public subscribe([Lio/reactivex/aa;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    .line 114
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableCombineLatest$LatestCoordinator;->actual:Lio/reactivex/ac;

    invoke-interface {v1, p0}, Lio/reactivex/ac;->onSubscribe(Lio/reactivex/disposables/b;)V
    ...
    invoke-interface {v1, v4}, Lio/reactivex/aa;->subscribe(Lio/reactivex/ac;)V
