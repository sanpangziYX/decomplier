...
.method public copy(Ljava/io/File;Ljava/io/File;Lorg/jcodec/movtool/MP4Edit;)Z
    ...
    .line 108
    :try_start_2
    invoke-direct {p0, v3, p3}, Lorg/jcodec/movtool/InplaceMP4Editor;->doTheFix(Lorg/jcodec/common/SeekableByteChannel;Lorg/jcodec/movtool/MP4Edit;)Ljava/util/List;
    :try_end_2
    ...
    :cond_0
    :try_start_3
    new-instance v1, Lorg/jcodec/movtool/InplaceMP4Editor$1;

    invoke-direct {v1, p0}, Lorg/jcodec/movtool/InplaceMP4Editor$1;-><init>(Lorg/jcodec/movtool/InplaceMP4Editor;)V

    invoke-static {v0, v1}, Lorg/jcodec/common/Tuple;->_2map0(Ljava/util/List;Lorg/jcodec/common/Tuple$Mapper;)Ljava/util/List;

    move-result-object v0

    .line 119
    invoke-static {v0}, Lorg/jcodec/common/Tuple;->asMap(Ljava/lang/Iterable;)Ljava/util/Map;

    move-result-object v4

    .line 120
    invoke-static {v3}, Lorg/jcodec/containers/mp4/MP4Util;->getRootAtoms(Lorg/jcodec/common/SeekableByteChannel;)Ljava/util/List;
    ...
    :cond_1
    :try_start_4
    invoke-virtual {v0, v3, v2}, Lorg/jcodec/containers/mp4/MP4Util$Atom;->copy(Lorg/jcodec/common/SeekableByteChannel;Ljava/nio/channels/WritableByteChannel;)V
    :try_end_4
...
.method public modify(Ljava/io/File;Lorg/jcodec/movtool/MP4Edit;)Z
    ...
    .line 63
    :try_start_1
    invoke-direct {p0, v2, p2}, Lorg/jcodec/movtool/InplaceMP4Editor;->doTheFix(Lorg/jcodec/common/SeekableByteChannel;Lorg/jcodec/movtool/MP4Edit;)Ljava/util/List;
    :try_end_1
    ...
    invoke-direct {p0, v2, v1, v0}, Lorg/jcodec/movtool/InplaceMP4Editor;->replaceBox(Lorg/jcodec/common/SeekableByteChannel;Lorg/jcodec/containers/mp4/MP4Util$Atom;Ljava/nio/ByteBuffer;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
