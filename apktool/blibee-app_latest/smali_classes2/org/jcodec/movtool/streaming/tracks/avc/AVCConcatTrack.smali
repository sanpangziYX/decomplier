...
.method public varargs constructor <init>([Lorg/jcodec/movtool/streaming/VirtualTrack;)V
    ...
    const-string/jumbo v1, "Not an AVC track."
    ...
    const-string/jumbo v1, "Can not concat video tracks with different Pixel Aspect Ratio."
    ...
    const-string/jumbo v1, "Unable to concat AVC tracks with different NAL length size in AvcC box"
...
.method private patchPacket(ILjava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    const-string/jumbo v4, "Skipping NAL unit: "
