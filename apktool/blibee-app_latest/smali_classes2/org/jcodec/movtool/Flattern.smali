...
.method private calcSpaceReq(Lorg/jcodec/containers/mp4/boxes/MovieBox;)I
    ...
    const-string/jumbo v9, "stbl"

    aput-object v9, v7, v8

    const/4 v8, 0x3

    const-string/jumbo v9, "stco"
...
.method public static main([Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "Syntax: self <ref movie> <out movie>"
...
.method public flattern(Lorg/jcodec/containers/mp4/boxes/MovieBox;Lorg/jcodec/common/SeekableByteChannel;)V
    ...
    const-string/jumbo v7, "movie should be reference"
    ...
    const-string/jumbo v7, "Not enough space to write the header"
...
.method protected getInputs(Lorg/jcodec/containers/mp4/boxes/MovieBox;)[[Lorg/jcodec/common/SeekableByteChannel;
    ...
    const-string/jumbo v8, "dinf"

    aput-object v8, v6, v7

    const/4 v7, 0x3

    const-string/jumbo v8, "dref"
    ...
    const-string/jumbo v1, "No data references"
...
.method public resolveDataRef(Lorg/jcodec/containers/mp4/boxes/Box;)Lorg/jcodec/common/SeekableByteChannel;
    ...
    const-string/jumbo v1, "Only file:// urls are supported in data reference"
    ...
    const-string/jumbo v1, "Could not resolve alias"
    ...
    const-string/jumbo v2, " dataref type is not supported"
