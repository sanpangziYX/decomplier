...
.method private static final pass1(Ljava/nio/ShortBuffer;)V
    ...
    invoke-virtual {v9, v0}, Ljava/nio/ShortBuffer;->get(I)S
    ...
    invoke-virtual {v9, v1}, Ljava/nio/ShortBuffer;->get(I)S
    ...
    invoke-virtual {v9, v2}, Ljava/nio/ShortBuffer;->get(I)S
    ...
    invoke-virtual {v9, v3}, Ljava/nio/ShortBuffer;->get(I)S
    ...
    invoke-virtual {v9, v0, v2}, Ljava/nio/ShortBuffer;->put(IS)Ljava/nio/ShortBuffer;
    ...
    invoke-static {v9, v0}, Lorg/jcodec/common/dct/FfmpegIntDct;->advance(Ljava/nio/ShortBuffer;I)Ljava/nio/ShortBuffer;
    ...
    invoke-static {v4, v5}, Lorg/jcodec/common/dct/FfmpegIntDct;->MULTIPLY(IS)I
    ...
    invoke-static {v3, v5}, Lorg/jcodec/common/dct/FfmpegIntDct;->MULTIPLY(IS)I
    ...
    invoke-virtual {v9, v10, v11}, Ljava/nio/ShortBuffer;->put(IS)Ljava/nio/ShortBuffer;
    ...
    invoke-virtual {v9, v10, v2}, Ljava/nio/ShortBuffer;->put(IS)Ljava/nio/ShortBuffer;
    ...
    invoke-static {v7}, Lorg/jcodec/common/dct/FfmpegIntDct;->DESCALE11(I)S

    move-result v7

    invoke-virtual {v9, v2, v7}, Ljava/nio/ShortBuffer;->put(IS)Ljava/nio/ShortBuffer;
    ...
    invoke-virtual {v9, v2, v3}, Ljava/nio/ShortBuffer;->put(IS)Ljava/nio/ShortBuffer;
    ...
    invoke-virtual {v9, v2, v0}, Ljava/nio/ShortBuffer;->put(IS)Ljava/nio/ShortBuffer;
    ...
    invoke-virtual {v9, v0, v1}, Ljava/nio/ShortBuffer;->put(IS)Ljava/nio/ShortBuffer;
...
.method private static final pass2(Ljava/nio/ShortBuffer;)V
    ...
    invoke-virtual {v9, v10, v0}, Ljava/nio/ShortBuffer;->put(IS)Ljava/nio/ShortBuffer;
    ...
    invoke-virtual {v9, v0, v7}, Ljava/nio/ShortBuffer;->put(IS)Ljava/nio/ShortBuffer;
    ...
    invoke-static {v0, v4}, Lorg/jcodec/common/dct/FfmpegIntDct;->MULTIPLY(IS)I
