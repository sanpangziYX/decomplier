...
.method private writeDecRefPicMarking(Lorg/jcodec/codecs/h264/io/model/SliceHeader;ZLorg/jcodec/common/io/BitWriter;)V
    ...
    const-string/jumbo v2, "SH: no_output_of_prior_pics_flag"
    ...
    const-string/jumbo v1, "SH: long_term_reference_flag"
    ...
    :goto_1
    const-string/jumbo v3, "SH: adaptive_ref_pic_marking_mode_flag"
    ...
    .line 128
    sget-object v6, Lorg/jcodec/codecs/h264/io/write/SliceHeaderWriter$1;->$SwitchMap$org$jcodec$codecs$h264$io$model$RefPicMarking$InstrType:[I
    ...
    .line 130
    :pswitch_0
    const-string/jumbo v6, "SH: memory_management_control_operation"
    ...
    const-string/jumbo v6, "SH: difference_of_pic_nums_minus1"
    ...
    const-string/jumbo v7, "SH: memory_management_control_operation"
    ...
    const-string/jumbo v6, "SH: long_term_pic_num"
    ...
    const-string/jumbo v7, "SH: difference_of_pic_nums_minus1"
    ...
    const-string/jumbo v6, "SH: long_term_frame_idx"
    ...
    const-string/jumbo v6, "SH: max_long_term_frame_idx_plus1"
    ...
    .line 155
    :cond_3
    const-string/jumbo v0, "SH: memory_management_control_operation"
...
.method private writeOffsetWeight(Lorg/jcodec/codecs/h264/io/model/SliceHeader;Lorg/jcodec/common/io/BitWriter;I)V
    ...
    .line 181
    :goto_1
    const-string/jumbo v7, "SH: luma_weight_l0_flag"
    ...
    const-string/jumbo v8, "SH: luma_weight_l"
    ...
    const-string/jumbo v8, "SH: luma_offset_l"
    ...
    .line 191
    :goto_2
    const-string/jumbo v7, "SH: chroma_weight_l0_flag"
    ...
    const-string/jumbo v9, "SH: chroma_weight_l"
    ...
    const-string/jumbo v9, "SH: chroma_offset_l"
...
.method private writePredWeightTable(Lorg/jcodec/codecs/h264/io/model/SliceHeader;Lorg/jcodec/common/io/BitWriter;)V
    ...
    const-string/jumbo v2, "SH: luma_log2_weight_denom"
    ...
    const-string/jumbo v1, "SH: chroma_log2_weight_denom"
...
.method private writeRefPicListReordering(Lorg/jcodec/codecs/h264/io/model/SliceHeader;Lorg/jcodec/common/io/BitWriter;)V
    ...
    :goto_0
    const-string/jumbo v3, "SH: ref_pic_list_reordering_flag_l0"
    ...
    :cond_1
    const-string/jumbo v0, "SH: ref_pic_list_reordering_flag_l1"
...
.method private writeReorderingList([[ILorg/jcodec/common/io/BitWriter;)V
    ...
    const-string/jumbo v3, "SH: reordering_of_pic_nums_idc"
    ...
    const-string/jumbo v3, "SH: abs_diff_pic_num_minus1"
    ...
    const-string/jumbo v1, "SH: reordering_of_pic_nums_idc"
...
.method public write(Lorg/jcodec/codecs/h264/io/model/SliceHeader;ZILorg/jcodec/common/io/BitWriter;)V
    ...
    const-string/jumbo v5, "SH: first_mb_in_slice"
    ...
    const-string/jumbo v5, "SH: slice_type"
    ...
    const-string/jumbo v5, "SH: pic_parameter_set_id"
    ...
    const-string/jumbo v6, "SH: frame_num"
    ...
    const-string/jumbo v5, "SH: field_pic_flag"
    ...
    const-string/jumbo v5, "SH: bottom_field_flag"
    ...
    const-string/jumbo v5, "SH: idr_pic_id"
    ...
    const-string/jumbo v5, "SH: delta_pic_order_cnt_bottom"
    ...
    const-string/jumbo v5, "SH: delta_pic_order_cnt"
    ...
    const-string/jumbo v5, "SH: redundant_pic_cnt"
    ...
    const-string/jumbo v5, "SH: direct_spatial_mv_pred_flag"
    ...
    const-string/jumbo v5, "SH: num_ref_idx_active_override_flag"
    ...
    const-string/jumbo v2, "SH: num_ref_idx_l0_active_minus1"
    ...
    const-string/jumbo v2, "SH: num_ref_idx_l1_active_minus1"
    ...
    const-string/jumbo v2, "SH: cabac_init_idc"
    ...
    const-string/jumbo v2, "SH: slice_qp_delta"
    ...
    const-string/jumbo v2, "SH: sp_for_switch_flag"
    ...
    const-string/jumbo v2, "SH: slice_qs_delta"
    ...
    const-string/jumbo v2, "SH: disable_deblocking_filter_idc"
    ...
    const-string/jumbo v2, "SH: slice_alpha_c0_offset_div2"
    ...
    const-string/jumbo v2, "SH: slice_beta_offset_div2"
