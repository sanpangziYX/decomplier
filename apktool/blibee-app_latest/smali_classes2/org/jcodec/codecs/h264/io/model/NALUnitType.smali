...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v1, "NON_IDR_SLICE"

    const/4 v2, 0x0

    const-string/jumbo v3, "non IDR slice"
    ...
    const-string/jumbo v1, "SLICE_PART_A"

    const-string/jumbo v2, "slice part a"
    ...
    const-string/jumbo v1, "SLICE_PART_B"

    const-string/jumbo v2, "slice part b"
    ...
    const-string/jumbo v1, "SLICE_PART_C"

    const-string/jumbo v2, "slice part c"
    ...
    const-string/jumbo v1, "IDR_SLICE"

    const-string/jumbo v2, "idr slice"
    ...
    const-string/jumbo v4, "sequence parameter set"
    ...
    const-string/jumbo v4, "picture parameter set"
    ...
    const-string/jumbo v1, "ACC_UNIT_DELIM"

    const/16 v2, 0x8

    const/16 v3, 0x9

    const-string/jumbo v4, "access unit delimiter"
    ...
    const-string/jumbo v1, "END_OF_SEQ"

    const/16 v2, 0x9

    const/16 v3, 0xa

    const-string/jumbo v4, "end of sequence"
    ...
    const-string/jumbo v1, "END_OF_STREAM"
    ...
    const-string/jumbo v1, "FILLER_DATA"

    const/16 v2, 0xb

    const/16 v3, 0xc

    const-string/jumbo v4, "filter data"
    ...
    const-string/jumbo v1, "SEQ_PAR_SET_EXT"

    const/16 v2, 0xc

    const/16 v3, 0xd

    const-string/jumbo v4, "sequence parameter set extension"
    ...
    const-string/jumbo v1, "AUX_SLICE"

    const/16 v2, 0xd

    const/16 v3, 0x13

    const-string/jumbo v4, "auxilary slice"
