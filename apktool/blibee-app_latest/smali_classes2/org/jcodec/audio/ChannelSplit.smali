...
.method public filter([Ljava/nio/FloatBuffer;[J[Ljava/nio/FloatBuffer;)V
    ...
    const-string/jumbo v1, "Channel split invoked on more then one input"
    ...
    const-string/jumbo v2, "Channel split must be supplied with "
    ...
    const-string/jumbo v2, " output buffers to hold the channels."
    ...
    const-string/jumbo v4, "Supplied buffer for "
    ...
    const-string/jumbo v4, "th channel doesn\'t have sufficient space to put the samples ( required: "
