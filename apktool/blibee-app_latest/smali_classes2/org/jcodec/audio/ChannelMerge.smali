...
.method public filter([Ljava/nio/FloatBuffer;[J[Ljava/nio/FloatBuffer;)V
    ...
    const-string/jumbo v2, "Channel merge must be supplied with "
    ...
    const-string/jumbo v2, " input buffers to hold the channels."
    ...
    const-string/jumbo v1, "Channel merget invoked on more then one output"
    ...
    const-string/jumbo v3, "Supplied output buffer is not big enough to hold "
    ...
    const-string/jumbo v2, " output samples."
