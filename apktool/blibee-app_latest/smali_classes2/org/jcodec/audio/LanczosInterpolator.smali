...
.source "LanczosInterpolator.java"
...
.method public filter([Ljava/nio/FloatBuffer;[J[Ljava/nio/FloatBuffer;)V
    ...
    const-string/jumbo v4, " filter is designed to work only on one input"
    ...
    const-string/jumbo v4, " filter is designed to work only on one output"
    ...
    const-string/jumbo v3, "Output buffer is too small"
    ...
    const-string/jumbo v3, "Input buffer should contain > 6 samples."
