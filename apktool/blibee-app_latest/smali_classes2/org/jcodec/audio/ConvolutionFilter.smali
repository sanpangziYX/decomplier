...
.method public filter([Ljava/nio/FloatBuffer;[J[Ljava/nio/FloatBuffer;)V
    ...
    const-string/jumbo v2, " filter is designed to work only on one input"
    ...
    const-string/jumbo v2, " filter is designed to work only on one output"
    ...
    iget-object v4, p0, Lorg/jcodec/audio/ConvolutionFilter;->kernel:[D
    ...
    const-string/jumbo v1, "Output buffer is too small"
    ...
    const-string/jumbo v2, "Input buffer should contain > kernel lenght ("
