...
.method private a()Landroid/os/Bundle;
    ...
    const-string/jumbo v2, "composeLoginStateParams fail, accesstoken or openid or appid is null"
...
.method private a(Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string/jumbo v1, "reportForVia() error: reportType or result is null"
    ...
    const-string/jumbo v2, "GameAppOperation -- reportForVia() error: unknow type "
...
.method private a(Landroid/app/Activity;Landroid/os/Bundle;Lcom/tencent/tauth/IUiListener;)Z
    ...
    const-string/jumbo v2, "activity or params or listener is null!"
    ...
    const-string/jumbo v2, "\u4f20\u5165\u53c2\u6570\u4e0d\u53ef\u4ee5\u4e3a\u7a7a: app_name"
    ...
    .line 1033
    const-string/jumbo v7, "file_data"
    ...
    const-string/jumbo v2, "\u4f20\u5165\u53c2\u6570\u6709\u8bef!: unknow req_type"
    ...
    const-string/jumbo v2, "\u4f20\u5165\u53c2\u6570\u4e0d\u53ef\u4ee5\u4e3a\u7a7a: description is null"
    ...
    const-string/jumbo v2, "\u4f20\u5165\u53c2\u6570\u4e0d\u53ef\u4ee5\u4e3a\u7a7a: fill_data is null"
    ...
    const-string/jumbo v2, "\u4f20\u5165\u53c2\u6570\u4e0d\u53ef\u4ee5\u4e3a\u7a7a: image_url or url is null"
    ...
    const-string/jumbo v2, "\u4f20\u5165\u53c2\u6570\u4e0d\u53ef\u4ee5\u4e3a\u7a7a: image_url or url or audioUrl is null"
...
.method public addToQQFavorites(Landroid/app/Activity;Landroid/os/Bundle;Lcom/tencent/tauth/IUiListener;)V
    ...
    const-string/jumbo v2, "addToQQFavorites() -- start"
    ...
    const-string/jumbo v2, "-->addToQQFavorites check parames failed"
    ...
    const-string/jumbo v1, "mqqapi://share/to_qqfav?src_type=app&version=1&file_type=news"
    ...
    .line 344
    :goto_1
    const-string/jumbo v1, "file_data"
    ...
    const-string/jumbo v14, "addToQQFavorites openId:"
    ...
    invoke-static {v1, v13}, Lcom/tencent/open/a/f;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 363
    const-string/jumbo v15, "openSDK_LOG.GameAppOperation"

    const-string/jumbo v16, "UnsupportedEncodingException"
    ...
    const-string/jumbo v3, "&file_data="
    ...
    const-string/jumbo v3, "addToQQFavorites url: "
    ...
    const-string/jumbo v8, "addToQQFavorites"
    ...
    invoke-virtual {v2, v3, v0}, Lcom/tencent/connect/common/UIListenerManager;->setListnerWithAction(Ljava/lang/String;Lcom/tencent/tauth/IUiListener;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, v1}, Lcom/tencent/open/GameAppOperation;->hasActivityForIntent(Landroid/content/Intent;)Z
    ...
    invoke-static {v0, v2}, Lcom/tencent/open/utils/Util;->isQQVersionBelow(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    const-string/jumbo v2, "addToQQFavorites() --end"
    ...
    .line 424
    const-string/jumbo v2, "openSDK_LOG.GameAppOperation"

    const-string/jumbo v3, "-->addToQQFavorites, start activity exception."
    ...
    const-string/jumbo v2, "-->addToQQFavorites, there is no activity, show download page."
...
.method public exchangePrize(Landroid/content/Context;Landroid/os/Bundle;Lcom/tencent/tauth/IUiListener;)V
    ...
    const-string/jumbo v1, "exchangePrize listener is null!"
    ...
    .line 889
    const-string/jumbo v2, "exchangePrize params is null!"

    .line 890
    const-string/jumbo v3, "openSDK_LOG.GameAppOperation"
    ...
    .line 896
    :cond_2
    const-string/jumbo v2, "exchangePrize failed, auth token is illegal."
    ...
    .line 902
    const-string/jumbo v2, "exchangePrize failed, context is null."
    ...
    .line 908
    :cond_4
    const-string/jumbo v2, "shareid_list"
    ...
    .line 910
    const-string/jumbo v2, "exchangePrize failed, shareid_list is empty."
...
.method public isActivityAvailable(Landroid/app/Activity;Ljava/lang/String;Lcom/tencent/tauth/IUiListener;)V
    ...
    .line 978
    const-string/jumbo v2, "isActivityAvailable failed, activityId is null."
...
.method public queryUnexchangePrize(Landroid/content/Context;Landroid/os/Bundle;Lcom/tencent/tauth/IUiListener;)V
    ...
    .line 831
    :cond_2
    const-string/jumbo v2, "queryUnexchangePrize failed, auth token is illegal."
    ...
    .line 837
    const-string/jumbo v2, "queryUnexchangePrize failed, context is null."
    ...
    .line 845
    const-string/jumbo v2, "queryUnexchangePrize failed, activityId is empty."
...
.method public releaseResource()V
    ...
    const-string/jumbo v1, "releaseResource() -- start"
    ...
    const-string/jumbo v1, "releaseResource() -- end"
...
.method public sendToMyComputer(Landroid/app/Activity;Landroid/os/Bundle;Lcom/tencent/tauth/IUiListener;)V
    ...
    const-string/jumbo v3, "sendToMyComputer() --start"
    ...
    const-string/jumbo v3, "-->sendToMyComputer check parames failed"
    ...
    const-string/jumbo v2, "mqqapi://share/to_qqdataline?src_type=app&version=1&file_type=news"
    ...
    .line 457
    :goto_1
    const-string/jumbo v2, "file_data"
    ...
    .line 476
    const-string/jumbo v16, "openSDK_LOG.GameAppOperation"

    const-string/jumbo v17, "UnsupportedEncodingException"
    ...
    const-string/jumbo v4, "&file_data="
    ...
    const-string/jumbo v3, "&audioUrl="
    ...
    const-string/jumbo v4, "sendToMyComputer url: "
    ...
    const-string/jumbo v9, "sendToMyComputer"
    ...
    const-string/jumbo v4, "sendToMyComputer"
    ...
    const-string/jumbo v3, "5.2.0"

    move-object/from16 v0, p1

    invoke-static {v0, v3}, Lcom/tencent/open/utils/Util;->isQQVersionBelow(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    const-string/jumbo v3, "sendToMyComputer() --end"
    ...
    const-string/jumbo v4, "-->sendToMyComputer, start activity exception."
    ...
    const-string/jumbo v3, "-->sendToMyComputer, there is no activity, show download page."
...
.method public sharePrizeToQQ(Landroid/app/Activity;Landroid/os/Bundle;Lcom/tencent/tauth/IUiListener;)V
    ...
    const-string/jumbo v1, "sharePrizeToQQ() -- start"
    ...
    .line 727
    :cond_1
    const-string/jumbo v2, "activity or params is null!"
    ...
    .line 735
    const-string/jumbo v2, "sharePrizeToQQ failed, title is empty."
    ...
    .line 742
    const-string/jumbo v2, "sharePrizeToQQ failed, sumary is empty."
    ...
    .line 749
    :cond_5
    const-string/jumbo v2, "sharePrizeToQQ failed, imageUrl is empty or illegal."
    ...
    .line 757
    const-string/jumbo v2, "sharePrizeToQQ failed, activityId is empty."
    ...
    const-string/jumbo v1, "sharePrizeToQQ() -- end"
...
.method public shareToTroopBar(Landroid/app/Activity;Landroid/os/Bundle;Lcom/tencent/tauth/IUiListener;)V
    ...
    const-string/jumbo v1, "shareToTroopBar() -- start"
    ...
    const-string/jumbo v2, "\u4f20\u5165\u53c2\u6570\u4e0d\u53ef\u4ee5\u4e3a\u7a7a: title is null"
    ...
    const-string/jumbo v1, "shareToTroopBar() -- title is null"
    ...
    const-string/jumbo v2, "\u4f20\u5165\u53c2\u6570\u6709\u8bef!: title size: 4 ~ 25"
    ...
    const-string/jumbo v1, "shareToTroopBar() -- title size: 4 ~ 25"
    ...
    const-string/jumbo v1, "shareToTroopBar() -- description is null"
    ...
    const-string/jumbo v2, "\u4f20\u5165\u53c2\u6570\u6709\u8bef!: description size: 10 ~ 700"
    ...
    const-string/jumbo v1, "shareToTroopBar() -- description size: 10 ~ 700"
    ...
    const-string/jumbo v2, "\u4f20\u5165\u53c2\u6570\u6709\u8bef!: file_data size: 1 ~ 9"
    ...
    const-string/jumbo v1, "shareToTroopBar() -- file_data size: 1 ~ 9"
    ...
    const-string/jumbo v3, "file_data\u5e94\u8be5\u4e3a\u672c\u5730\u56fe\u7247"
    ...
    const-string/jumbo v1, "shareToTroopBar(): file_data\u5e94\u8be5\u4e3a\u672c\u5730\u56fe\u7247"
    ...
    const-string/jumbo v1, "shareToTroopBar(): \u56fe\u7247\u6587\u4ef6\u4e0d\u5b58\u5728"
    ...
    .line 629
    const-string/jumbo v7, "openSDK_LOG.GameAppOperation"
    ...
    .line 637
    :cond_e
    const-string/jumbo v0, "troopbar_id"
    ...
    const-string/jumbo v2, "\u4f20\u5165\u53c2\u6570\u6709\u8bef! troopbar_id \u5fc5\u987b\u4e3a\u6570\u5b57"
    ...
    const-string/jumbo v1, "shareToTroopBar(): troopbar_id \u5fc5\u987b\u4e3a\u6570\u5b57"
    ...
    const-string/jumbo v0, "mqqapi://share/to_troopbar?src_type=app&version=1&file_type=news"
    ...
    const-string/jumbo v9, "shareToTroopBar() -- openId: "
    ...
    const-string/jumbo v2, "&troopbar_id="
    ...
    const-string/jumbo v2, "shareToTroopBar, url: "
    ...
    const-string/jumbo v2, "requireApi"
    ...
    const-string/jumbo v6, "shareToTroopBar"
    ...
    const-string/jumbo v3, "ANDROIDSDK.SHARETOTROOPBAR.XX"
    ...
    const-string/jumbo v1, "shareToTroopBar() -- end"
    ...
    const-string/jumbo v2, "-->shareToTroopBar, start activity exception."
    ...
    const-string/jumbo v1, "-->shareToTroopBar, there is no activity, show download page."
