...
.method private a(Ljava/lang/String;[BLjava/lang/String;Ljava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    .line 238
    const-string/jumbo v0, "destUrl is null."
    ...
    .line 244
    const-string/jumbo v0, "Failed to get HttpURLConnection object."
    ...
    .line 276
    :cond_2
    const-string/jumbo v0, "Failed to upload, please check your network."
...
.method public final a(Ljava/lang/String;[BLcom/tencent/bugly/proguard/v;Ljava/util/Map;)[B
    ...
    .line 78
    const-string/jumbo v4, "Failed for no URL."
    ...
    .line 85
    :goto_1
    const-string/jumbo v6, "request: %s, send: %d (pid=%d | tid=%d)"
    ...
    .line 108
    const-string/jumbo v10, "Failed to request for network not avail"
    ...
    const-string/jumbo v11, "try time: "
    ...
    const-string/jumbo v11, "Failed to redirect: %d"
    ...
    .line 138
    :try_start_5
    const-string/jumbo v6, "redirect code: %d ,to:%s"
    ...
    .line 160
    :cond_10
    const-string/jumbo v10, "Failed to execute post."
