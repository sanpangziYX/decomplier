...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 52
    const-string/jumbo v0, "bugly_db"
...
.method public final declared-synchronized onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 82
    const-string/jumbo v1, " CREATE TABLE IF NOT EXISTS t_ui"
    ...
    .line 93
    const-string/jumbo v1, " CREATE TABLE IF NOT EXISTS t_lr"
    ...
    .line 104
    const-string/jumbo v1, " CREATE TABLE IF NOT EXISTS t_pf"
    ...
    const-string/jumbo v2, ",primary key(_id"
    ...
    .line 114
    const-string/jumbo v1, " CREATE TABLE IF NOT EXISTS t_cr"
    ...
    .line 127
    const-string/jumbo v1, " CREATE TABLE IF NOT EXISTS dl_1002"
    ...
    const-string/jumbo v2, " integer primary key autoincrement, _dUrl"

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    const-string/jumbo v2, " varchar(100), _sFile"

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    const-string/jumbo v2, " varchar(100), _sLen"

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    const-string/jumbo v2, " INTEGER, _tLen"

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    const-string/jumbo v2, " INTEGER, _MD5"

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    const-string/jumbo v2, " varchar(100), _DLTIME"
    ...
    .line 137
    const-string/jumbo v1, "CREATE TABLE IF NOT EXISTS ge_1002"
    ...
    const-string/jumbo v2, " integer primary key autoincrement, _time"

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    const-string/jumbo v2, " INTEGER, _datas"
    ...
    .line 145
    const-string/jumbo v1, " CREATE TABLE IF NOT EXISTS st_1002"
