...
.method public static readFirstDumpInfo(Ljava/lang/String;Z)Lcom/tencent/bugly/crashreport/crash/anr/TraceFileHelper$a;
    ...
    .line 192
    :cond_1
    const-string/jumbo v2, "first dump error %s"
...
.method public static readTraceFile(Ljava/lang/String;Lcom/tencent/bugly/crashreport/crash/anr/TraceFileHelper$b;)V
    ...
    .line 223
    :try_start_1
    const-string/jumbo v0, "-{5}\\spid\\s\\d+\\sat\\s\\d+-\\d+-\\d+\\s\\d{2}:\\d{2}:\\d{2}\\s-{5}"
    ...
    .line 224
    const-string/jumbo v1, "-{5}\\send\\s\\d+\\s-{5}"
    ...
    .line 226
    const-string/jumbo v1, "\".+\"\\s(daemon\\s){0,1}prio=\\d+\\stid=\\d+\\s.*"
