...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v0, p0, Lcom/xiaomi/mipush/sdk/m;->a:I

    const/4 v0, -0x1

    iput v0, p0, Lcom/xiaomi/mipush/sdk/m;->b:I

    const/16 v0, 0xe10

    iput v0, p0, Lcom/xiaomi/mipush/sdk/m;->c:I

    const-string/jumbo v0, "mipush_extra"

    iput-object v0, p0, Lcom/xiaomi/mipush/sdk/m;->d:Ljava/lang/String;

    const-string/jumbo v0, "GeoFenceNetInfoUpdateJob"

    iput-object v0, p0, Lcom/xiaomi/mipush/sdk/m;->e:Ljava/lang/String;

    const-string/jumbo v0, "last_upload_lbs_data_timestamp"

    iput-object v0, p0, Lcom/xiaomi/mipush/sdk/m;->f:Ljava/lang/String;

    iput-object p1, p0, Lcom/xiaomi/mipush/sdk/m;->g:Landroid/content/Context;

    new-instance v0, Lcom/xiaomi/mipush/sdk/n;

    invoke-direct {v0, p0}, Lcom/xiaomi/mipush/sdk/n;-><init>(Lcom/xiaomi/mipush/sdk/m;)V

    iput-object v0, p0, Lcom/xiaomi/mipush/sdk/m;->h:Ljava/util/Comparator;
...
.method private a(J)Z
    ...
    iget-object v1, p0, Lcom/xiaomi/mipush/sdk/m;->g:Landroid/content/Context;
    ...
    const-string/jumbo v2, "last_upload_lbs_data_timestamp"
...
.method private c()Z
    ...
    invoke-virtual {v1, v2, v3}, Lcom/xiaomi/push/service/i;->a(II)I

    move-result v1

    iget-object v2, p0, Lcom/xiaomi/mipush/sdk/m;->g:Landroid/content/Context;
    ...
    invoke-direct {p0, v2, v3}, Lcom/xiaomi/mipush/sdk/m;->a(J)Z
...
.method private d()Lcom/xiaomi/xmpush/thrift/m;
    ...
    invoke-direct {p0}, Lcom/xiaomi/mipush/sdk/m;->e()Ljava/util/List;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/xiaomi/xmpush/thrift/m;->a(Ljava/util/List;)Lcom/xiaomi/xmpush/thrift/m;

    invoke-direct {p0}, Lcom/xiaomi/mipush/sdk/m;->f()Ljava/util/List;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/xiaomi/xmpush/thrift/m;->b(Ljava/util/List;)Lcom/xiaomi/xmpush/thrift/m;

    invoke-direct {p0}, Lcom/xiaomi/mipush/sdk/m;->g()Lcom/xiaomi/xmpush/thrift/i;
...
.method private e()Ljava/util/List;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/xiaomi/mipush/sdk/m;->g:Landroid/content/Context;
    ...
    iget-object v0, p0, Lcom/xiaomi/mipush/sdk/m;->h:Ljava/util/Comparator;
...
.method private g()Lcom/xiaomi/xmpush/thrift/i;
    ...
    invoke-virtual {p0}, Lcom/xiaomi/mipush/sdk/m;->b()Z
    ...
    :cond_1
    invoke-direct {p0}, Lcom/xiaomi/mipush/sdk/m;->h()Landroid/location/Location;
...
.method private h()Landroid/location/Location;
    ...
    :goto_2
    invoke-direct {p0, v3, v2}, Lcom/xiaomi/mipush/sdk/m;->a(Landroid/location/Location;Landroid/location/Location;)Landroid/location/Location;

    move-result-object v1

    invoke-direct {p0, v0, v1}, Lcom/xiaomi/mipush/sdk/m;->a(Landroid/location/Location;Landroid/location/Location;)Landroid/location/Location;
...
.method public run()V
    ...
    const-string/jumbo v0, "GeoFenceNetInfoUpdateJobNetwork.is not Connected"
    ...
    :cond_0
    invoke-direct {p0}, Lcom/xiaomi/mipush/sdk/m;->c()Z

    move-result v0

    if-nez v0, :cond_1

    const-string/jumbo v0, "GeoFenceNetInfoUpdateJobverifyUploadData"
    ...
    :cond_1
    invoke-direct {p0}, Lcom/xiaomi/mipush/sdk/m;->d()Lcom/xiaomi/xmpush/thrift/m;
    ...
    invoke-direct {p0}, Lcom/xiaomi/mipush/sdk/m;->i()V

    const-string/jumbo v0, "GeoFenceNetInfoUpdateJob: update_loc_data"
