...
.method U()V
    ...
    .line 388
    :cond_2
    invoke-virtual {p0, v1}, Lio/reactivex/subjects/UnicastSubject;->f(Lio/reactivex/ac;)V
...
.method a(Lio/reactivex/internal/a/o;Lio/reactivex/ac;)Z
    ...
    .line 367
    invoke-interface {p2, v0}, Lio/reactivex/ac;->onError(Ljava/lang/Throwable;)V
...
.method protected d(Lio/reactivex/ac;)V
    ...
    invoke-interface {p1, v0}, Lio/reactivex/ac;->onSubscribe(Lio/reactivex/disposables/b;)V
    ...
    .line 208
    :cond_0
    invoke-virtual {p0}, Lio/reactivex/subjects/UnicastSubject;->U()V
    ...
    invoke-static {v0, p1}, Lio/reactivex/internal/disposables/EmptyDisposable;->error(Ljava/lang/Throwable;Lio/reactivex/ac;)V

    goto :goto_0
.end method

.method f(Lio/reactivex/ac;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 298
    invoke-virtual {p0, p1}, Lio/reactivex/subjects/UnicastSubject;->h(Lio/reactivex/ac;)V
    ...
    .line 307
    :cond_7
    invoke-interface {p1, v8}, Lio/reactivex/ac;->onNext(Ljava/lang/Object;)V
...
.method g(Lio/reactivex/ac;)V
    ...
    .line 338
    :cond_4
    invoke-interface {p1, v5}, Lio/reactivex/ac;->onNext(Ljava/lang/Object;)V
...
.method h(Lio/reactivex/ac;)V
    ...
    .line 358
    :cond_0
    invoke-interface {p1}, Lio/reactivex/ac;->onComplete()V
...
.method public onComplete()V
    ...
    .line 265
    invoke-virtual {p0}, Lio/reactivex/subjects/UnicastSubject;->P()V
