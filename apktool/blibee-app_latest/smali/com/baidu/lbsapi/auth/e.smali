...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/baidu/lbsapi/auth/e;->b:Ljava/lang/String;

    iput-object v0, p0, Lcom/baidu/lbsapi/auth/e;->c:Ljava/util/HashMap;

    iput-object v0, p0, Lcom/baidu/lbsapi/auth/e;->d:Ljava/lang/String;
...
.method private a(Ljavax/net/ssl/HttpsURLConnection;)V
    ...
    const-string/jumbo v1, "https Post start,url:"

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-object v1, p0, Lcom/baidu/lbsapi/auth/e;->b:Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/baidu/lbsapi/auth/e;->c:Ljava/util/HashMap;

    if-nez v0, :cond_0

    const-string/jumbo v0, "httpsPost request paramters is null."
    ...
    iget-object v3, p0, Lcom/baidu/lbsapi/auth/e;->c:Ljava/util/HashMap;

    invoke-static {v3}, Lcom/baidu/lbsapi/auth/e;->b(Ljava/util/HashMap;)Ljava/lang/String;
    ...
    const-string/jumbo v8, "httpsPost parse failed;"
    ...
    const-string/jumbo v9, "httpsPost failed,IOException:"
    ...
    const-string/jumbo v1, "httpsPost failed,statusCode:"
    ...
    iput-object v2, p0, Lcom/baidu/lbsapi/auth/e;->d:Ljava/lang/String;
    :try_end_9
    ...
    const-string/jumbo v6, "httpsPost failed,MalformedURLException:"
    ...
    const-string/jumbo v4, "httpsPost failed,IOException:"
    ...
    const-string/jumbo v4, "httpsPost failed,Exception:"
    ...
    :cond_f
    iget-object v0, p0, Lcom/baidu/lbsapi/auth/e;->d:Ljava/lang/String;

    if-nez v0, :cond_10

    const-string/jumbo v0, "httpsPost failed,mResult is null"

    invoke-static {v0}, Lcom/baidu/lbsapi/auth/a;->a(Ljava/lang/String;)V

    const-string/jumbo v0, "httpsPost failed,internal error"
    ...
    const-string/jumbo v1, "httpsPost success end,parse result = "

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-object v1, p0, Lcom/baidu/lbsapi/auth/e;->d:Ljava/lang/String;
...
.method private b()Ljavax/net/ssl/HttpsURLConnection;
    ...
    iget-object v2, p0, Lcom/baidu/lbsapi/auth/e;->b:Ljava/lang/String;
    ...
    const-string/jumbo v3, "https URL: "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v3, p0, Lcom/baidu/lbsapi/auth/e;->b:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/baidu/lbsapi/auth/e;->a:Landroid/content/Context;
    ...
    const-string/jumbo v2, "Current network is not available."
    ...
    :cond_2
    const-string/jumbo v0, "Auth server could not be parsed as a URL."
    ...
    :cond_5
    const-string/jumbo v0, "Init httpsurlconnection failed."
...
.method protected a(Ljava/util/HashMap;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, Lcom/baidu/lbsapi/auth/e;->c(Ljava/util/HashMap;)Ljava/util/HashMap;
    ...
    invoke-direct {p0}, Lcom/baidu/lbsapi/auth/e;->b()Ljavax/net/ssl/HttpsURLConnection;

    move-result-object v0

    if-nez v0, :cond_0

    const-string/jumbo v0, "syncConnect failed,httpsURLConnection is null"
    ...
    :cond_0
    invoke-direct {p0, v0}, Lcom/baidu/lbsapi/auth/e;->a(Ljavax/net/ssl/HttpsURLConnection;)V
...
.method protected a()Z
    ...
    const-string/jumbo v0, "checkNetwork start"

    invoke-static {v0}, Lcom/baidu/lbsapi/auth/a;->a(Ljava/lang/String;)V

    :try_start_0
    iget-object v0, p0, Lcom/baidu/lbsapi/auth/e;->a:Landroid/content/Context;
    ...
    :cond_3
    const-string/jumbo v0, "checkNetwork end"
