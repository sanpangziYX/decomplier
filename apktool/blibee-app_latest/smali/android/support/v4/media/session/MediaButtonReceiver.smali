...
.method public static a(Landroid/content/Context;Landroid/content/ComponentName;J)Landroid/app/PendingIntent;
    ...
    const-string/jumbo v2, "The component name of media button receiver should be provided."
    ...
    const-string/jumbo v3, "Cannot build a media button pending intent with the given action: "
...
.method public static a(Landroid/support/v4/media/session/MediaSessionCompat;Landroid/content/Intent;)Landroid/view/KeyEvent;
    ...
    .line 142
    invoke-virtual {p0}, Landroid/support/v4/media/session/MediaSessionCompat;->d()Landroid/support/v4/media/session/c;

    move-result-object v1

    .line 143
    invoke-virtual {v1, v0}, Landroid/support/v4/media/session/c;->a(Landroid/view/KeyEvent;)Z
