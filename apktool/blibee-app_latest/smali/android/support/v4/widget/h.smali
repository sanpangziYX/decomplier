...
.field protected f:Landroid/support/v4/widget/h$a;
    .annotation build Landroid/support/annotation/RestrictTo;
        a = {
            .enum Landroid/support/annotation/RestrictTo$Scope;->LIBRARY_GROUP:Landroid/support/annotation/RestrictTo$Scope;
        }
...
.method public constructor <init>(Landroid/content/Context;Landroid/database/Cursor;)V
    ...
    invoke-virtual {p0, p1, p2, v0}, Landroid/support/v4/widget/h;->a(Landroid/content/Context;Landroid/database/Cursor;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/database/Cursor;I)V
    ...
    .line 163
    invoke-virtual {p0, p1, p2, p3}, Landroid/support/v4/widget/h;->a(Landroid/content/Context;Landroid/database/Cursor;I)V
...
.method a(Landroid/content/Context;Landroid/database/Cursor;I)V
    ...
    .line 183
    :goto_1
    iput-object p2, p0, Landroid/support/v4/widget/h;->c:Landroid/database/Cursor;
    ...
    .line 188
    new-instance v1, Landroid/support/v4/widget/h$a;

    invoke-direct {v1, p0}, Landroid/support/v4/widget/h$a;-><init>(Landroid/support/v4/widget/h;)V

    iput-object v1, p0, Landroid/support/v4/widget/h;->f:Landroid/support/v4/widget/h$a;

    .line 189
    new-instance v1, Landroid/support/v4/widget/h$b;

    invoke-direct {v1, p0}, Landroid/support/v4/widget/h$b;-><init>(Landroid/support/v4/widget/h;)V

    iput-object v1, p0, Landroid/support/v4/widget/h;->g:Landroid/database/DataSetObserver;
    ...
    .line 196
    iget-object v0, p0, Landroid/support/v4/widget/h;->f:Landroid/support/v4/widget/h$a;
    ...
    .line 197
    :cond_0
    iget-object v0, p0, Landroid/support/v4/widget/h;->g:Landroid/database/DataSetObserver;
    ...
    .line 180
    :cond_2
    iput-boolean v1, p0, Landroid/support/v4/widget/h;->b:Z
    ...
    .line 191
    :cond_5
    iput-object v3, p0, Landroid/support/v4/widget/h;->f:Landroid/support/v4/widget/h$a;

    .line 192
    iput-object v3, p0, Landroid/support/v4/widget/h;->g:Landroid/database/DataSetObserver;
...
.method public a(Landroid/database/Cursor;)V
    ...
    .prologue
    .line 333
    invoke-virtual {p0, p1}, Landroid/support/v4/widget/h;->b(Landroid/database/Cursor;)Landroid/database/Cursor;
...
.method public a(Landroid/widget/FilterQueryProvider;)V
    ...
    .prologue
    .line 457
    iput-object p1, p0, Landroid/support/v4/widget/h;->i:Landroid/widget/FilterQueryProvider;
...
.method public b(Landroid/database/Cursor;)Landroid/database/Cursor;
    ...
    .line 355
    iget-object v1, p0, Landroid/support/v4/widget/h;->f:Landroid/support/v4/widget/h$a;
...
.method public getDropDownView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {p0, p2, v0, v1}, Landroid/support/v4/widget/h;->a(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;)V
...
.method public getFilter()Landroid/widget/Filter;
    ...
    .prologue
    .line 425
    iget-object v0, p0, Landroid/support/v4/widget/h;->h:Landroid/support/v4/widget/i;
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/widget/i;-><init>(Landroid/support/v4/widget/i$a;)V

    iput-object v0, p0, Landroid/support/v4/widget/h;->h:Landroid/support/v4/widget/i;
