...
.method static a(Landroid/widget/CompoundButton;)Landroid/content/res/ColorStateList;
    ...
    .prologue
    .line 45
    instance-of v0, p0, Landroid/support/v4/widget/as;

    if-eqz v0, :cond_0

    .line 46
    check-cast p0, Landroid/support/v4/widget/as;

    invoke-interface {p0}, Landroid/support/v4/widget/as;->getSupportButtonTintList()Landroid/content/res/ColorStateList;
...
.method static a(Landroid/widget/CompoundButton;Landroid/content/res/ColorStateList;)V
    ...
    invoke-interface {p0, p1}, Landroid/support/v4/widget/as;->setSupportButtonTintList(Landroid/content/res/ColorStateList;)V
...
.method static a(Landroid/widget/CompoundButton;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-interface {p0, p1}, Landroid/support/v4/widget/as;->setSupportButtonTintMode(Landroid/graphics/PorterDuff$Mode;)V
...
.method static b(Landroid/widget/CompoundButton;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-interface {p0}, Landroid/support/v4/widget/as;->getSupportButtonTintMode()Landroid/graphics/PorterDuff$Mode;
