...
.method protected static a(Landroid/content/Context;Landroid/support/v7/widget/l;I)Landroid/support/v7/widget/bg;
    .locals 3
...
.method a()V
    ...
    .prologue
    .line 172
    iget-object v0, p0, Landroid/support/v7/widget/y;->b:Landroid/support/v7/widget/bg;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/y;->c:Landroid/support/v7/widget/bg;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/y;->d:Landroid/support/v7/widget/bg;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/y;->e:Landroid/support/v7/widget/bg;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/y;->b:Landroid/support/v7/widget/bg;

    invoke-virtual {p0, v1, v2}, Landroid/support/v7/widget/y;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bg;)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/y;->c:Landroid/support/v7/widget/bg;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/y;->d:Landroid/support/v7/widget/bg;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/y;->e:Landroid/support/v7/widget/bg;

    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/y;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bg;)V
...
.method a(Landroid/content/Context;I)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/bi;->j(I)Z
...
.method final a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bg;)V
    ...
    invoke-static {p1, p2, v0}, Landroid/support/v7/widget/l;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bg;[I)V
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v6, p1, v3, p2, v2}, Landroid/support/v7/widget/bi;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bi;
    ...
    invoke-virtual {v3, v4, v8}, Landroid/support/v7/widget/bi;->g(II)I
    ...
    invoke-virtual {v3, v7}, Landroid/support/v7/widget/bi;->j(I)Z
    ...
    .line 64
    invoke-virtual {v3, v7, v2}, Landroid/support/v7/widget/bi;->g(II)I

    move-result v7

    .line 63
    invoke-static {v6, v0, v7}, Landroid/support/v7/widget/y;->a(Landroid/content/Context;Landroid/support/v7/widget/l;I)Landroid/support/v7/widget/bg;

    move-result-object v7

    iput-object v7, p0, Landroid/support/v7/widget/y;->b:Landroid/support/v7/widget/bg;
    ...
    iput-object v7, p0, Landroid/support/v7/widget/y;->c:Landroid/support/v7/widget/bg;
    ...
    iput-object v7, p0, Landroid/support/v7/widget/y;->d:Landroid/support/v7/widget/bg;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/y;->e:Landroid/support/v7/widget/bg;
    ...
    invoke-static {v6, v4, v0}, Landroid/support/v7/widget/bi;->a(Landroid/content/Context;I[I)Landroid/support/v7/widget/bi;
    ...
    invoke-virtual {v8, v0}, Landroid/support/v7/widget/bi;->j(I)Z
    ...
    invoke-virtual {v8, v0, v2}, Landroid/support/v7/widget/bi;->a(IZ)Z
    ...
    invoke-virtual {v8, v4}, Landroid/support/v7/widget/bi;->j(I)Z
    ...
    invoke-virtual {v8, v4}, Landroid/support/v7/widget/bi;->g(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v8, v9}, Landroid/support/v7/widget/bi;->j(I)Z
    ...
    invoke-virtual {v8, v5}, Landroid/support/v7/widget/bi;->g(I)Landroid/content/res/ColorStateList;
    ...
    :cond_4
    :goto_2
    invoke-virtual {v8}, Landroid/support/v7/widget/bi;->e()V

    .line 112
    :goto_3
    sget-object v8, Landroid/support/v7/a/b$l;->TextAppearance:[I

    invoke-static {v6, p1, v8, p2, v2}, Landroid/support/v7/widget/bi;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bi;
    ...
    invoke-virtual {v6, v8}, Landroid/support/v7/widget/bi;->j(I)Z
    ...
    invoke-virtual {v6, v0, v2}, Landroid/support/v7/widget/bi;->a(IZ)Z
    ...
    invoke-virtual {v6, v1}, Landroid/support/v7/widget/bi;->j(I)Z
    ...
    invoke-virtual {v6, v1}, Landroid/support/v7/widget/bi;->g(I)Landroid/content/res/ColorStateList;
    ...
    .line 129
    :cond_7
    invoke-virtual {v6}, Landroid/support/v7/widget/bi;->e()V
