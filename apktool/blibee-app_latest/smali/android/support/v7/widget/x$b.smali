...
.method public constructor <init>(Landroid/support/v7/widget/x;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/x$b;->q:Landroid/graphics/Rect;
...
.method public a()V
    ...
    .prologue
    .line 777
    invoke-virtual {p0}, Landroid/support/v7/widget/x$b;->e()Z
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/x$b;->k(I)V

    .line 782
    invoke-super {p0}, Landroid/support/v7/widget/an;->a()V

    .line 783
    invoke-virtual {p0}, Landroid/support/v7/widget/x$b;->g()Landroid/widget/ListView;
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/x$b;->l(I)V
...
.method public a(Ljava/lang/CharSequence;)V
    ...
    .prologue
    .line 736
    iput-object p1, p0, Landroid/support/v7/widget/x$b;->p:Ljava/lang/CharSequence;
...
.method a(Landroid/view/View;)Z
    ...
    .prologue
    .line 830
    invoke-static {p1}, Landroid/support/v4/view/aq;->ad(Landroid/view/View;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/x$b;->q:Landroid/graphics/Rect;
...
.method public b()Ljava/lang/CharSequence;
    ...
    .prologue
    .line 731
    iget-object v0, p0, Landroid/support/v7/widget/x$b;->p:Ljava/lang/CharSequence;
...
.method c()V
    ...
    .line 740
    invoke-virtual {p0}, Landroid/support/v7/widget/x$b;->k()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/x$b;->h(I)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/x$b;->p()I
    ...
    .line 773
    :goto_4
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/x$b;->d(I)V
