...
.method public constructor <init>(Landroid/view/View;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ai;->i:[I
    ...
    .line 78
    invoke-direct {p0, p1}, Landroid/support/v7/widget/ai;->a(Landroid/view/View;)V
    ...
    iput v0, p0, Landroid/support/v7/widget/ai;->a:F
    ...
    .line 80
    :cond_0
    invoke-direct {p0, p1}, Landroid/support/v7/widget/ai;->b(Landroid/view/View;)V

    goto :goto_0
.end method

.method static synthetic a(Landroid/support/v7/widget/ai;)V
    .locals 0
...
.method private a(Landroid/view/MotionEvent;)Z
    ...
    .line 204
    iget-object v2, p0, Landroid/support/v7/widget/ai;->c:Landroid/view/View;
    ...
    iput v1, p0, Landroid/support/v7/widget/ai;->h:I
    ...
    invoke-direct {v1, p0}, Landroid/support/v7/widget/ai$a;-><init>(Landroid/support/v7/widget/ai;)V

    iput-object v1, p0, Landroid/support/v7/widget/ai;->e:Ljava/lang/Runnable;
    ...
    invoke-direct {v1, p0}, Landroid/support/v7/widget/ai$b;-><init>(Landroid/support/v7/widget/ai;)V

    iput-object v1, p0, Landroid/support/v7/widget/ai;->f:Ljava/lang/Runnable;
    ...
    .line 231
    iget v5, p0, Landroid/support/v7/widget/ai;->a:F

    invoke-static {v2, v4, v3, v5}, Landroid/support/v7/widget/ai;->a(Landroid/view/View;FFF)Z
...
.method private b(Landroid/view/MotionEvent;)Z
    ...
    .line 294
    invoke-virtual {p0}, Landroid/support/v7/widget/ai;->a()Landroid/support/v7/view/menu/t;
    ...
    invoke-interface {v0}, Landroid/support/v7/view/menu/t;->e()Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ag;->isShown()Z
    ...
    .line 306
    invoke-direct {p0, v3, v4}, Landroid/support/v7/widget/ai;->b(Landroid/view/View;Landroid/view/MotionEvent;)Z

    .line 307
    invoke-direct {p0, v0, v4}, Landroid/support/v7/widget/ai;->a(Landroid/view/View;Landroid/view/MotionEvent;)Z

    .line 310
    iget v3, p0, Landroid/support/v7/widget/ai;->h:I

    invoke-virtual {v0, v4, v3}, Landroid/support/v7/widget/ag;->a(Landroid/view/MotionEvent;I)Z
...
.method d()V
    ...
    .line 262
    iget-object v8, p0, Landroid/support/v7/widget/ai;->c:Landroid/view/View;
    ...
    .line 282
    iput-boolean v9, p0, Landroid/support/v7/widget/ai;->g:Z
...
.method public onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    .line 133
    iget-boolean v10, p0, Landroid/support/v7/widget/ai;->g:Z
    ...
    .line 145
    iget-object v1, p0, Landroid/support/v7/widget/ai;->c:Landroid/view/View;
