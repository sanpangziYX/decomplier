...
.field private static f:Landroid/support/v7/widget/l;

.field private static final g:Landroid/support/v7/widget/l$b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/l;->c:Landroid/graphics/PorterDuff$Mode;
    ...
    sput-object v0, Landroid/support/v7/widget/l;->g:Landroid/support/v7/widget/l$b;
    ...
    sput-object v0, Landroid/support/v7/widget/l;->j:[I
    ...
    sput-object v0, Landroid/support/v7/widget/l;->k:[I
    ...
    sput-object v0, Landroid/support/v7/widget/l;->l:[I
    ...
    sput-object v0, Landroid/support/v7/widget/l;->m:[I
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/l;->q:Ljava/lang/Object;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/l;->r:Ljava/util/WeakHashMap;
...
.method public static a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    .prologue
    .line 685
    sget-object v0, Landroid/support/v7/widget/l;->g:Landroid/support/v7/widget/l$b;
    ...
    .line 690
    sget-object v1, Landroid/support/v7/widget/l;->g:Landroid/support/v7/widget/l$b;
...
.method private a(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 267
    invoke-static {p4}, Landroid/support/v7/widget/af;->c(Landroid/graphics/drawable/Drawable;)Z
    ...
    sget-object v3, Landroid/support/v7/widget/l;->c:Landroid/graphics/PorterDuff$Mode;
    ...
    sget-object v2, Landroid/support/v7/widget/l;->c:Landroid/graphics/PorterDuff$Mode;
...
.method private a(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    .line 394
    iget-object v3, p0, Landroid/support/v7/widget/l;->q:Ljava/lang/Object;

    monitor-enter v3

    .line 395
    :try_start_0
    iget-object v0, p0, Landroid/support/v7/widget/l;->r:Ljava/util/WeakHashMap;
...
.method public static a()Landroid/support/v7/widget/l;
    ...
    .prologue
    .line 85
    sget-object v0, Landroid/support/v7/widget/l;->f:Landroid/support/v7/widget/l;
    ...
    sput-object v0, Landroid/support/v7/widget/l;->f:Landroid/support/v7/widget/l;
...
.method private static a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    .prologue
    .line 697
    invoke-static {p0}, Landroid/support/v7/widget/af;->c(Landroid/graphics/drawable/Drawable;)Z
    ...
    sget-object p2, Landroid/support/v7/widget/l;->c:Landroid/graphics/PorterDuff$Mode;
...
.method static a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bg;[I)V
    ...
    :cond_4
    sget-object v1, Landroid/support/v7/widget/l;->c:Landroid/graphics/PorterDuff$Mode;
...
.method private static a(Landroid/support/v7/widget/l;)V
    .locals 2
    .param p0    # Landroid/support/v7/widget/l;
        .annotation build Landroid/support/annotation/z;
        .end annotation
    .end param
...
.method private a(Ljava/lang/String;Landroid/support/v7/widget/l$c;)V
    ...
    .param p1    # Ljava/lang/String;
        ...
        .end annotation
    .end param
    .param p2    # Landroid/support/v7/widget/l$c;
        .annotation build Landroid/support/annotation/z;
        .end annotation
    .end param
    ...
    .prologue
    .line 494
    iget-object v0, p0, Landroid/support/v7/widget/l;->o:Landroid/support/v4/k/a;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/l;->o:Landroid/support/v4/k/a;
...
.method static a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    .line 447
    sget-object v5, Landroid/support/v7/widget/l;->c:Landroid/graphics/PorterDuff$Mode;

    .line 452
    sget-object v4, Landroid/support/v7/widget/l;->h:[I
    ...
    .line 472
    invoke-static {p2}, Landroid/support/v7/widget/af;->c(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 455
    :cond_2
    sget-object v4, Landroid/support/v7/widget/l;->j:[I
    ...
    .line 458
    :cond_3
    sget-object v4, Landroid/support/v7/widget/l;->k:[I
...
.method private a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    .line 420
    iget-object v2, p0, Landroid/support/v7/widget/l;->q:Ljava/lang/Object;
    ...
    .line 424
    iget-object v3, p0, Landroid/support/v7/widget/l;->r:Ljava/util/WeakHashMap;
...
.method private static a(Landroid/graphics/drawable/Drawable;)Z
    ...
    .prologue
    .line 720
    instance-of v0, p0, Landroid/support/e/a/g;
...
.method private b(Ljava/lang/String;Landroid/support/v7/widget/l$c;)V
    .locals 1
    .param p1    # Ljava/lang/String;
        .annotation build Landroid/support/annotation/z;
        .end annotation
...
.method private c(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 232
    iget-object v0, p0, Landroid/support/v7/widget/l;->s:Landroid/util/TypedValue;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/l;->s:Landroid/util/TypedValue;

    .line 235
    :cond_0
    iget-object v1, p0, Landroid/support/v7/widget/l;->s:Landroid/util/TypedValue;
...
.method private d(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 310
    iget-object v0, p0, Landroid/support/v7/widget/l;->p:Landroid/util/SparseArray;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/l;->o:Landroid/support/v4/k/a;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/l;->p:Landroid/util/SparseArray;
    ...
    .line 330
    :cond_4
    iget-object v2, p0, Landroid/support/v7/widget/l;->s:Landroid/util/TypedValue;
    ...
    .line 385
    iget-object v1, p0, Landroid/support/v7/widget/l;->p:Landroid/util/SparseArray;
    ...
    .line 362
    iget-object v7, p0, Landroid/support/v7/widget/l;->p:Landroid/util/SparseArray;

    invoke-virtual {v7, p2, v0}, Landroid/util/SparseArray;->append(ILjava/lang/Object;)V

    .line 365
    iget-object v7, p0, Landroid/support/v7/widget/l;->o:Landroid/support/v4/k/a;
...
.method private e(Landroid/content/Context;)V
    ...
    .prologue
    .line 704
    iget-boolean v0, p0, Landroid/support/v7/widget/l;->t:Z
    ...
    iput-boolean v0, p0, Landroid/support/v7/widget/l;->t:Z
...
.method a(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    .line 211
    invoke-static {v0}, Landroid/support/v7/widget/af;->b(Landroid/graphics/drawable/Drawable;)V
...
.method a(Landroid/content/Context;Landroid/support/v7/widget/bk;I)Landroid/graphics/drawable/Drawable;
    .locals 2
    .param p1    # Landroid/content/Context;
        .annotation build Landroid/support/annotation/z;
        .end annotation
    .end param
    .param p2    # Landroid/support/v7/widget/bk;
        .annotation build Landroid/support/annotation/z;
        .end annotation
    .end param
    .param p3    # I
...
.method public a(Landroid/content/Context;)V
    ...
    .prologue
    .line 217
    iget-object v1, p0, Landroid/support/v7/widget/l;->q:Ljava/lang/Object;
