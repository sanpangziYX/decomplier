...
.field d:Landroid/support/v7/widget/ba$a;

.field private f:I

.field private final g:Landroid/support/v7/widget/ba$c;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/ba$c;-><init>(Landroid/support/v7/widget/ba;)V

    iput-object v0, p0, Landroid/support/v7/widget/ba;->g:Landroid/support/v7/widget/ba$c;

    .line 184
    const-string/jumbo v0, "share_history.xml"

    iput-object v0, p0, Landroid/support/v7/widget/ba;->c:Ljava/lang/String;
...
.method private i()V
    ...
    .prologue
    .line 382
    iget-object v0, p0, Landroid/support/v7/widget/ba;->d:Landroid/support/v7/widget/ba$a;
    ...
    .line 385
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/ba;->h:Landroid/support/v7/widget/d$f;

    if-nez v0, :cond_1

    .line 386
    new-instance v0, Landroid/support/v7/widget/ba$b;

    invoke-direct {v0, p0}, Landroid/support/v7/widget/ba$b;-><init>(Landroid/support/v7/widget/ba;)V

    iput-object v0, p0, Landroid/support/v7/widget/ba;->h:Landroid/support/v7/widget/d$f;

    .line 388
    :cond_1
    iget-object v0, p0, Landroid/support/v7/widget/ba;->b:Landroid/content/Context;

    iget-object v1, p0, Landroid/support/v7/widget/ba;->c:Ljava/lang/String;
    ...
    .line 389
    iget-object v1, p0, Landroid/support/v7/widget/ba;->h:Landroid/support/v7/widget/d$f;
...
.method public a(Landroid/content/Intent;)V
    ...
    .line 344
    :cond_0
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/ba;->b(Landroid/content/Intent;)V
...
.method public a(Landroid/support/v7/widget/ba$a;)V
    .locals 0

    .prologue
    .line 211
    iput-object p1, p0, Landroid/support/v7/widget/ba;->d:Landroid/support/v7/widget/ba$a;

    .line 212
    invoke-direct {p0}, Landroid/support/v7/widget/ba;->i()V
...
.method public a(Landroid/view/SubMenu;)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ba;->c:Ljava/lang/String;
    ...
    iget-object v7, p0, Landroid/support/v7/widget/ba;->g:Landroid/support/v7/widget/ba$c;
...
.method public a(Ljava/lang/String;)V
    ...
    .prologue
    .line 320
    iput-object p1, p0, Landroid/support/v7/widget/ba;->c:Ljava/lang/String;
...
.method public b()Landroid/view/View;
    ...
    invoke-static {v2, v1}, Landroid/support/v7/b/a/b;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
