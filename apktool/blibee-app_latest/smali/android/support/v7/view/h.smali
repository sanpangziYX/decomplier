...
.field b:Landroid/support/v4/view/bt;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/view/h;->f:Landroid/support/v4/view/bu;
...
.method public a(Landroid/support/v4/view/bn;)Landroid/support/v7/view/h;
    .locals 1
...
.method public a(Landroid/support/v4/view/bn;Landroid/support/v4/view/bn;)Landroid/support/v7/view/h;
    .locals 2
    ...
    .line 61
    invoke-virtual {p1}, Landroid/support/v4/view/bn;->a()J

    move-result-wide v0

    invoke-virtual {p2, v0, v1}, Landroid/support/v4/view/bn;->b(J)Landroid/support/v4/view/bn;
...
.method public a(Landroid/support/v4/view/bt;)Landroid/support/v7/view/h;
    .locals 1
    ...
    .line 114
    iput-object p1, p0, Landroid/support/v7/view/h;->b:Landroid/support/v4/view/bt;
...
.method public a()V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/view/bn;->a(Landroid/view/animation/Interpolator;)Landroid/support/v4/view/bn;

    .line 75
    :cond_2
    iget-object v2, p0, Landroid/support/v7/view/h;->b:Landroid/support/v4/view/bt;

    if-eqz v2, :cond_3

    .line 76
    iget-object v2, p0, Landroid/support/v7/view/h;->f:Landroid/support/v4/view/bu;
