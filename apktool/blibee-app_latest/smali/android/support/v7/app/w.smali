...
.field private static f:Landroid/support/v7/app/w; = null
...
.method static a()Landroid/support/v7/app/w;
    .locals 1

    .prologue
    .line 31
    sget-object v0, Landroid/support/v7/app/w;->f:Landroid/support/v7/app/w;
    ...
    invoke-direct {v0}, Landroid/support/v7/app/w;-><init>()V

    sput-object v0, Landroid/support/v7/app/w;->f:Landroid/support/v7/app/w;
...
.method public a(JDD)V
    ...
    iput v2, p0, Landroid/support/v7/app/w;->e:I

    .line 115
    const-wide/16 v2, -0x1

    iput-wide v2, p0, Landroid/support/v7/app/w;->c:J

    .line 116
    const-wide/16 v2, -0x1

    iput-wide v2, p0, Landroid/support/v7/app/w;->d:J
    ...
    iput-wide v6, p0, Landroid/support/v7/app/w;->c:J
    ...
    .line 130
    iget-wide v2, p0, Landroid/support/v7/app/w;->d:J

    cmp-long v2, v2, p1

    if-gez v2, :cond_2

    iget-wide v2, p0, Landroid/support/v7/app/w;->c:J
