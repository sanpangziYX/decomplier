.class public Lcom/amap/api/col/O0Oo;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/amap/api/services/geocoder/O000000o;)V
    .locals 0
...
.method protected synthetic O000000o(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .prologue
    .line 15
    invoke-virtual {p0, p1}, Lcom/amap/api/col/O0Oo;->O00000o(Ljava/lang/String;)Ljava/util/ArrayList;
...
.method protected O00000o(Ljava/lang/String;)Ljava/util/ArrayList;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 32
    invoke-static {v1}, Lcom/amap/api/col/OooOO;->O00000oO(Lorg/json/JSONObject;)Ljava/util/ArrayList;
    :try_end_0
...
.method protected O0000O0o()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/amap/api/col/O0Oo;->O000000o:Ljava/lang/Object;

    check-cast v0, Lcom/amap/api/services/geocoder/O000000o;

    .line 51
    invoke-virtual {v0}, Lcom/amap/api/services/geocoder/O000000o;->O000000o()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/amap/api/col/O0Oo;->O00000Oo(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/amap/api/services/geocoder/O000000o;->O00000Oo()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/amap/api/col/O0Oo;->O00000o:Landroid/content/Context;
